...
IntegratedPreviewScientificProductReleaseBundleV1 = Object.freeze({
  ...
  catalogRefs: Object.freeze({
    cases: Object.freeze({
      ...
      version: "1.0.0",
      digestSemantics: "sha256-canonical-json-catalog-slot" as const,
      sha256: "281b4445011761285f347c5f89d3242b26870faf5519e90cf20f61510c15b51c",
    }),
    controls: Object.freeze({
      id: "scientific-product-integrated-preview-control-catalog-v1",
      version: "1.0.0",
      digestSemantics: "sha256-canonical-json-catalog-slot" as const,
      sha256: "1adbeae5c6fcc34b909107c84b757100ae8188255f1f0c82d28838909cafc815",
    }),
    observables: Object.freeze({
      id: "scientific-product-integrated-preview-observable-catalog-v1",
      version: "1.0.0",
      digestSemantics: "sha256-canonical-json-catalog-slot" as const,
      sha256: "9898059a6a57ef8366a2772eb89d69a92dad0bd317cd3abdadf721e6a41d9fad",
    }),
    ui: Object.freeze({
      id: "scientific-product-integrated-preview-ui-catalog-v1",
      version: "1.0.0",
      digestSemantics: "sha256-canonical-json-catalog-slot" as const,
      sha256: "f869e25d28f17752c8f15907aca52873a3c9df9588e1963cb7c838561585eea9",
    }),
  }),
  catalogs: Object.freeze({
