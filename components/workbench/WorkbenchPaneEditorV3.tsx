...
export function duplicateWorkbenchSurfacePaneV3(
  ...
  return {
    ...
    surface: {
      ...surface,
      [key]: [...surface[key], copy],
    },
  };
}

/**
 * Build one side-by-side Output comparison without introducing item-level
 * Scenario bindings. The source's current binding is materialized first, then
 * its independent copy is fixed to the next Scenario that is not already
 * represented by an equivalent Output pane.
 */
