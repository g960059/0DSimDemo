...
const SIGNAL_METADATA: Record<string, { label: string; category: Exclude<SignalCategory, 'All'>; unit?: string }> = {
  ...
  ELV_active: { label: 'LV PV elastance (active)', category: 'Derived', unit: 'mmHg/mL' },
  ERV_active: { label: 'RV PV elastance (active)', category: 'Derived', unit: 'mmHg/mL' },
  ELV_timeVarying: { label: 'LV elastance fallback', category: 'Derived', unit: 'mmHg/mL' },
  ERV_timeVarying: { label: 'RV elastance fallback', category: 'Derived', unit: 'mmHg/mL' },
