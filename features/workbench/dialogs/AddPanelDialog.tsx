  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-lg shadow-2xl p-6 w-full max-w-lg">
        <h2 className="text-lg font-bold text-slate-200 mb-4 tracking-tight">Configure {panelType} Panel</h2>
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button onClick={onConfirm} className="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold rounded shadow transition-colors">Add Panel</button>
        </div>
      </div>
    </div>
  );
