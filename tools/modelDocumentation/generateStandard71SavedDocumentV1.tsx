...
import { Standard71DocumentV1 } from "./authoring/Standard71DocumentV1";
import measurements from "@/studio/presentation/modelDocumentation/standard71-documentation-snapshot-v1.json";
import equations from "@/studio/presentation/modelDocumentation/standard71-equation-data-v1.json";
...
const target = "studio/presentation/modelDocumentation/packages/standard71-document-v1.json";
const sha = (value: string) => createHash("sha256").update(value).digest("hex");
const files = [
  "tools/modelDocumentation/generateStandard71SavedDocumentV1.tsx",
  "tools/modelDocumentation/authoring/Standard71DocumentV1.tsx",
  "tools/modelDocumentation/authoring/Standard71EquationDetailsV1.tsx",
  ...
  "studio/presentation/modelDocumentation/standard71-documentation-snapshot-v1.json",
  "studio/presentation/modelDocumentation/standard71-equation-data-v1.json",
  "studio/presentation/StudioItemPresentationCatalogV1.ts",
  "locales/ja/translation.json", "locales/en/translation.json", "index.css", "package-lock.json",
];
...
try {
  ...
  for (const locale of ["ja", "en"] as const) {
    ...
    for (const recordIndex of [0, 1] as const) {
      const html = renderToStaticMarkup(<MemoryRouter><Standard71DocumentV1 locale={locale} recordIndex={recordIndex} /></MemoryRouter>);
...
const body: Omit<SavedModelDocumentV1, "contentSha256"> = {
  schemaId: "circleheart.saved-model-document.v1", documentId: "standard71-document-v1",
  identity: { modelId: measurements.modelId, surfaceReleaseId: measurements.surfaceReleaseId,
    ...
    title: "Main Wire Standard 71", releaseStatus: measurements.releaseStatus },
  provenance: {
  ...
  scientificRecord: { measurements, equations,
    modules: STANDARD71_MODULE_IDS_V1.map(id => MAIN_WIRE_MODEL_MODULES_V1.find(m => m.id === id)!),
    equationSpecification: MAIN_WIRE_EQUATION_SPECIFICATION_V1 },
  filenames: { measurements: "standard71-documentation-snapshot-v1.json", tables: "standard71-equations-parameters-initial-state.csv", archive: "standard71-document-v1.html" },
  archiveCss,
};
...
const archiveDirectory = "artifacts/model-documentation/releases/standard71-document-v1";
if (!process.argv.includes("--check")) {
