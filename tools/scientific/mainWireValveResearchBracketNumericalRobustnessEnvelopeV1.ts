...
export const MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_ROBUSTNESS_ENVELOPE_V1_ID =
  "main-wire-valve-research-bracket-numerical-robustness-envelope-v1" as const;

export const MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_HEALTH_THRESHOLDS_V1 =
  Object.freeze({
...
export const MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_CASES_V1 = Object.freeze([
  Object.freeze({
...
export type MainWireValveResearchBracketNumericalCaseSummaryV1 = Readonly<{
  caseId: string;
...
export type MainWireValveResearchBracketNumericalEnvelopeSummaryV1 = Readonly<{
  envelopeId:
    typeof MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_ROBUSTNESS_ENVELOPE_V1_ID;
  role:
  ...
  numericalHealthThresholds:
    typeof MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_HEALTH_THRESHOLDS_V1;
  cases: readonly MainWireValveResearchBracketNumericalCaseSummaryV1[];
  overallPass: boolean;
}>;

export function runMainWireValveResearchBracketNumericalRobustnessEnvelopeV1(
  dtSec = 0.002,
): MainWireValveResearchBracketNumericalEnvelopeSummaryV1 {
  ...
  const cases = MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_CASES_V1.map((definition) =>
    runCase(definition, dtSec, stepsPerBeat));
  return Object.freeze({
    envelopeId:
      MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_ROBUSTNESS_ENVELOPE_V1_ID,
    role:
    ...
    numericalHealthThresholds:
      MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_HEALTH_THRESHOLDS_V1,
...
function runCase(
  definition: (typeof MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_CASES_V1)[number],
  dtSec: number,
  requestedStepCount: number,
): MainWireValveResearchBracketNumericalCaseSummaryV1 {
  try {
...
function runInitializedCase(
  ...
  let failure: MainWireValveResearchBracketNumericalCaseSummaryV1["failure"] = null;
  ...
  const jacobianMode = jacobianModesObserved.length === 0
    ...
    : jacobianModesObserved.length === 1
      ...
      : "multiple" as const;
  const thresholds = MAIN_WIRE_VALVE_RESEARCH_BRACKET_NUMERICAL_HEALTH_THRESHOLDS_V1;
...
function freezeValveVolumes(
...
): MainWireValveResearchBracketNumericalCaseSummaryV1["valveIntegratedVolumeMl"] {
  ...
  ]))) as MainWireValveResearchBracketNumericalCaseSummaryV1[
