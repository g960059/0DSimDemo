...
import {
  MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_ARM_IDS_V1,
  MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_CLAIM_V1,
  MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_FACTORIAL_V1_ID,
} from "@/engine/myocardium/experiments/MainWireAorticOutflowVelocityDistortionPreloadFactorialV1";
import {
  runMainWireNormalAdultFiveWallAorticOutflowVelocityDistortionPreloadResearchArmV1,
...
const arms =
  MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_ARM_IDS_V1.map(
    (armId) => {
      const run =
        runMainWireNormalAdultFiveWallAorticOutflowVelocityDistortionPreloadResearchArmV1(
...
const report = Object.freeze({
  ...
  design: Object.freeze({
    ...
    armOrder:
      MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_ARM_IDS_V1,
    claim: MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_DISTORTION_PRELOAD_CLAIM_V1,
  }),
  arms,
  interpretationBoundary: Object.freeze({
    preloadIsOrthogonalMacroRecalibrationAxis: true as const,
...
if (outputPath === null) {
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    arms: report.arms.map((arm) => ({
      ...
      preloadScale:
        arm.arm.canonicalAdditionalStressedVenousVolumeScale,
      fixedTotalBloodVolumeMl: arm.fixedTotalBloodVolumeMl,
