...
import {
  runCoronaryV3ReducedPressureStepNumericalCharacterizationV2,
} from "@/engine/coronary/experiments/CoronaryV3ReducedPressureStepNumericalCharacterizationV2";

export const CORONARY_V3_REDUCED_PRESSURE_STEP_NUMERICAL_ARTIFACT_PATH_V2 =
  "artifacts/coronary-v3/reduced-pressure-step-numerical-v2.json" as const;

const outputPath = optionalArgument("--output");
const result = runCoronaryV3ReducedPressureStepNumericalCharacterizationV2();
