...
export const MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_STIFFNESS_EXPERIMENT_V1_ID =
  "main-wire-aortic-outflow-velocity-stiffness-experiment-v1" as const;
...
const comparison = compareMainWireAorticOutflowVelocityStiffnessFactorialV1(
...
const report = Object.freeze({
  ...
  experimentId: MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_STIFFNESS_EXPERIMENT_V1_ID,
  design: Object.freeze({
    dtSec,
    maximumBeatCount,
    armOrder: MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_STIFFNESS_ARM_IDS_V1,
    ablationClaim: MAIN_WIRE_AORTIC_OUTFLOW_VELOCITY_STIFFNESS_CLAIM_V1,
  }),
  ...
  interpretationBoundary: Object.freeze({
    ...
    arterialStiffnessRecalibrationEstablished: false as const,
    outcomeInformedCombinationIsIndependentValidation: false as const,
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    arms: report.comparison.arms.map((arm) => ({
      ...
      arterialStiffnessScale:
        arm.circulatoryLoadPoint.arterialStiffnessScaleFromBaseline,
