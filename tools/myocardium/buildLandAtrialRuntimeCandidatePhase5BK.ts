...
import phase5BJArtifact from "@/data/myocardium/protocols/landatrial-geometry-scout-phase5bj-result-v1.json";
...
import {
  ...
  LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_ID as LANDATRIAL_RUNTIME_CANDIDATE_SOURCE_ID,
...
export const LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_ID =
  "landatrial-runtime-candidate-phase5bk-result-v1";
export const LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_RESULT_PATH =
...
type CandidateId =
  ...
  | "landatrial-shadow-current-geometry"
  | "landatrial-runtime-candidate-la22-ra26"
  | "landatrial-neighbor-la20-ra24"
  | "landatrial-neighbor-la18-ra24"
  | "landatrial-neighbor-la20-ra22"
  | "landatrial-neighbor-la18-ra22"
  | "landatrial-neighbor-la22-ra24"
  | "landatrial-neighbor-la20-ra26"
  | "landatrial-neighbor-la20-ra20";
type PointId =
  | "normal-hr75"
  | "low-preload-hr75"
  | "high-preload-hr75"
...
type CandidateSpec = {
  ...
  readonly usesLandAtrialShadow: boolean;
  readonly usesRuntimeCandidateHelper?: boolean;
...
type Evidence = {
  ...
  readonly id: typeof LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_ID;
  readonly phase: "Phase 5BK";
  readonly claimBoundary: "landatrial-runtime-candidate-user0-staged-default-no-physiology-acceptance";
  ...
  readonly protocol: {
    ...
    readonly scoredTargets: readonly [
      ...
      "runtime-candidate-health-and-target-distance",
    ];
    readonly noA1A2GainSweep: true;
    readonly noAtrialPhysiologyAcceptance: true;
    readonly runtimeDefaultPromotion: "user0-staged-all-chamber-landatrial-default";
  ...
  readonly phase5BJDigest: {
    readonly phase5bjStatus: string;
    readonly phase5bjHash: string;
    readonly phase5bjRecommendedCandidateId: string | null;
    readonly phase5bjRecommendedOverrides: Partial<Record<AtrialChamber, Record<string, number>>> | null;
  };
  readonly runtimeCandidateContract: {
    readonly candidateId: typeof LANDATRIAL_RUNTIME_CANDIDATE_SOURCE_ID;
    readonly claimBoundary: typeof LANDATRIAL_RUNTIME_CANDIDATE_CLAIM_BOUNDARY;
    readonly sourceProviderIds: typeof LANDATRIAL_RUNTIME_CANDIDATE_SOURCE_PROVIDER_IDS;
    readonly activeOverrides: typeof LANDATRIAL_RUNTIME_CANDIDATE_ACTIVE_OVERRIDES;
  };
  readonly points: readonly PointSpec[];
  readonly candidateSummaries: readonly CandidateSummary[];
  readonly runtimeCandidateRecommendation: {
  ...
  readonly summary: {
    readonly diagnosticStatus:
      | "landatrial-runtime-candidate-recorded"
      | "landatrial-runtime-candidate-health-or-output-blocked"
      | "landatrial-runtime-candidate-runtime-error";
  ...
  readonly boundary: {
    readonly allChamberRuntimeDefaultFlip: "user0-staged-default-only";
    readonly noAtrialPhysiologyAcceptance: true;
...
const CANDIDATES: readonly CandidateSpec[] = [
  {
    ...
    usesLandAtrialShadow: false,
    rationale: "Current user-0 LV+RV Land plus sourced root/Zc runtime default with existing active-stress atria.",
  },
  {
    id: "landatrial-shadow-current-geometry",
    usesLandAtrialShadow: true,
    rationale: "Promoted Phase 5BH LA+RA LandAtrial shadow pack with current atrial wall geometry and AV-plane gains.",
  },
  {
    id: "landatrial-runtime-candidate-la22-ra26",
    usesLandAtrialShadow: true,
    usesRuntimeCandidateHelper: true,
    activeOverrides: {
      LA: { ...LANDATRIAL_RUNTIME_CANDIDATE_ACTIVE_OVERRIDES.LA },
      RA: { ...LANDATRIAL_RUNTIME_CANDIDATE_ACTIVE_OVERRIDES.RA },
    },
    rationale: "Reusable Phase 5BK LandAtrial runtime candidate from the Phase 5BK preflight best neighbor: LA avPlaneGainMl=22, RA avPlaneGainMl=26.",
  },
  {
    id: "landatrial-neighbor-la20-ra24",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 20 },
      RA: { avPlaneGainMl: 24 },
    },
    rationale: "Phase 5BJ recommended geometry reference: LA avPlaneGainMl=20, RA avPlaneGainMl=24.",
  },
  {
    id: "landatrial-neighbor-la18-ra24",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 18 },
      RA: { avPlaneGainMl: 24 },
    },
    rationale: "Narrow-neighbor check: reduce LA AV-plane gain while holding the RA candidate gain.",
  },
  {
    id: "landatrial-neighbor-la20-ra22",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 20 },
      RA: { avPlaneGainMl: 22 },
    },
    rationale: "Narrow-neighbor check: reduce RA AV-plane gain to recover volume-function pass while preserving target distance.",
  },
  {
    id: "landatrial-neighbor-la18-ra22",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 18 },
      RA: { avPlaneGainMl: 22 },
    },
    rationale: "Narrow-neighbor check: step both atrial AV-plane gains below the Phase 5BJ candidate.",
  },
  {
    id: "landatrial-neighbor-la22-ra24",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 22 },
      RA: { avPlaneGainMl: 24 },
    },
    rationale: "Narrow-neighbor check: increase LA AV-plane gain beyond the Phase 5BJ candidate.",
  },
  {
    id: "landatrial-neighbor-la20-ra26",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 20 },
      RA: { avPlaneGainMl: 26 },
    },
    rationale: "Narrow-neighbor check: increase RA AV-plane gain beyond the Phase 5BJ candidate.",
  },
  {
    id: "landatrial-neighbor-la20-ra20",
    usesLandAtrialShadow: true,
    activeOverrides: {
      LA: { avPlaneGainMl: 20 },
      RA: { avPlaneGainMl: 20 },
    },
    rationale: "Narrow-neighbor check: preserve LA candidate gain while testing lower RA gain for volume-function pass recovery.",
  },
] as const;

export function buildLandAtrialRuntimeCandidatePhase5BKEvidence(): Evidence {
  ...
  const runtimeCandidateRecommendation = computeScoutRecommendation(candidateSummaries);
  const evidenceWithoutHash: Omit<Evidence, "normalizedSha256"> = {
    schemaVersion: 1,
    id: LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_ID,
    phase: "Phase 5BK",
    claimBoundary: "landatrial-runtime-candidate-user0-staged-default-no-physiology-acceptance",
    ...
    protocol: {
      ...
      runtimeDefaultPromotion: "user0-staged-all-chamber-landatrial-default",
    ...
    phase5BJDigest: {
      phase5bjStatus: phase5BJArtifact.summary.diagnosticStatus,
      phase5bjHash: phase5BJArtifact.normalizedSha256,
      phase5bjRecommendedCandidateId: phase5BJArtifact.scoutRecommendation.recommendedCandidateId ?? null,
      phase5bjRecommendedOverrides: phase5BJArtifact.scoutRecommendation.recommendedActiveOverrides ?? null,
    },
    runtimeCandidateContract: {
      candidateId: LANDATRIAL_RUNTIME_CANDIDATE_SOURCE_ID,
      claimBoundary: LANDATRIAL_RUNTIME_CANDIDATE_CLAIM_BOUNDARY,
      sourceProviderIds: LANDATRIAL_RUNTIME_CANDIDATE_SOURCE_PROVIDER_IDS,
      activeOverrides: LANDATRIAL_RUNTIME_CANDIDATE_ACTIVE_OVERRIDES,
    },
    points: POINTS,
    candidateSummaries,
    runtimeCandidateRecommendation,
    runs,
    summary: {
      diagnosticStatus,
      bestCandidateByCombinedTargetDistanceId: best?.candidateId ?? null,
      currentInterpretation: interpretation(candidateSummaries, best, diagnosticStatus, runtimeCandidateRecommendation),
      recommendedNext: recommendedNext(diagnosticStatus, runtimeCandidateRecommendation),
      blockers: [
        "Phase 5BK preflights a reusable LandAtrial runtime candidate for user-0 staged default, but does not accept atrial physiology.",
    ...
    boundary: {
      allChamberRuntimeDefaultFlip: "user0-staged-default-only",
      noAtrialPhysiologyAcceptance: true,
...
function runPoint(candidate: CandidateSpec, point: PointSpec): Run {
  try {
    ...
    const landInstrumentation = candidate.usesRuntimeCandidateHelper
      ? createLandAtrialRuntimeCandidateInstrumentation()
      : candidate.usesLandAtrialShadow
        ? {
    ...
    const activeSourceProviders: Partial<Record<Chamber, ModelCoreExperimentalActiveSourceProvider>> = {
      ...
      ...createCandidateProviders(candidate, landInstrumentation),
    };
    ...
    return {
      ...
      instrumentation: {
        LA: landInstrumentation ? compactInstrumentation(landInstrumentation.LA) : null,
        RA: landInstrumentation ? compactInstrumentation(landInstrumentation.RA) : null,
      },
...
function createCandidateProviders(
  ...
  instrumentation: LandAtrialRuntimeCandidateInstrumentation | null,
): Partial<Record<Chamber, ModelCoreExperimentalActiveSourceProvider>> {
  if (!candidate.usesLandAtrialShadow) {
    return {};
  }
  if (!instrumentation) {
    throw new Error("LandAtrial candidate requires LA/RA instrumentation.");
  }
  if (candidate.usesRuntimeCandidateHelper) {
    return createLandAtrialRuntimeCandidateProviders(instrumentation);
  }
...
function classifyDiagnosticStatus(
  ...
  if (summaries.some((summary) => summary.runtimeErrorPointIds.length > 0)) {
    return "landatrial-runtime-candidate-runtime-error";
  }
  const current = summaries.find((summary) => summary.candidateId === "landatrial-shadow-current-geometry");
  const runtimeCandidate = summaries.find((summary) =>
    summary.candidateId === "landatrial-runtime-candidate-la22-ra26");
  if (
    !current
    || !runtimeCandidate
    || current.healthOkPointIds.length < POINTS.length
    || current.outputPreservedPointIds.length < POINTS.length
    || runtimeCandidate.healthOkPointIds.length < POINTS.length
    || runtimeCandidate.outputPreservedPointIds.length < POINTS.length
  ) {
    return "landatrial-runtime-candidate-health-or-output-blocked";
  }
  return "landatrial-runtime-candidate-recorded";
}
...
function computeScoutRecommendation(
  summaries: readonly CandidateSummary[],
): Evidence["runtimeCandidateRecommendation"] {
  const current = summaries.find((summary) => summary.candidateId === "landatrial-shadow-current-geometry");
...
function interpretation(
  ...
  scoutRecommendation: Evidence["runtimeCandidateRecommendation"],
): string {
  const current = summaries.find((summary) => summary.candidateId === "landatrial-shadow-current-geometry");
  return [
    "Phase 5BK freezes A1/A2 and scouts LandAtrial AV-plane/effective wall geometry candidates against sourced atrial volume-function targets plus direct wall-lambda strain targets.",
...
function recommendedNext(
  ...
  if (diagnosticStatus !== "landatrial-runtime-candidate-recorded") {
    return [
  ...
  return [
    ...
    "keep official morphology, AF validation, valve/load timing acceptance, and qDot clamp retirement out of this lane until smaller standing gates exist",
  ];
}
...
function writeEvidence(): Evidence {
  const evidence = buildLandAtrialRuntimeCandidatePhase5BKEvidence();
  const outPath = path.resolve(process.cwd(), LANDATRIAL_RUNTIME_CANDIDATE_PHASE5BK_RESULT_PATH);
...
if (isDirectRun) {
  ...
  const current = evidence.candidateSummaries
    .find((summary) => summary.candidateId === "landatrial-shadow-current-geometry");
  const recommended = evidence.runtimeCandidateRecommendation.recommendedCandidateId
    ? evidence.candidateSummaries.find((summary) =>
      summary.candidateId === evidence.runtimeCandidateRecommendation.recommendedCandidateId)
    : null;
  console.log(JSON.stringify({
    ...
    recommendedCandidateId: evidence.runtimeCandidateRecommendation.recommendedCandidateId,
    recommendedMeanCombinedTargetDistance: recommended?.meanCombinedTargetDistance ?? null,
    runtimeCandidateRecommendation: evidence.runtimeCandidateRecommendation,
  }, null, 2));
}
