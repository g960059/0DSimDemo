...
const OUTPUT_PATH =
  "data/mechanics2/visuals/atrial-two-state-reservoir-transaction-pv-review.svg" as const;
...
const report = runAtrialTwoStateReservoirTransactionBenchV1();
  ...
  return {
    ...
    series: [
      ...
      },
      {
        ...
        color: "#22c55e",
        samples: runLeftHeartSubsystemV2(
          applyAtrialTwoStateReservoirTransactionVariantV1(params, reviewVariant),
        ).finalBeatSamples,
      },
    ],
  };
...
function selectReviewVariantId(): AtrialTwoStateReservoirTransactionVariantIdV1 {
...
function variantById(
  ...
  const variant = ATRIAL_TWO_STATE_RESERVOIR_TRANSACTION_VARIANTS_V1.find((candidate) =>
...
function renderSvg(
  ...
  bestVariantId: AtrialTwoStateReservoirTransactionVariantIdV1,
): string {
  ...
  <text x="28" y="30" fill="#e5e7eb" font-family="Arial, sans-serif" font-size="18" font-weight="700">Atrial two-state reservoir transaction PV review</text>
