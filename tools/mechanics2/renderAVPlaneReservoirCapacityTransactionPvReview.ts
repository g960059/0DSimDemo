...
import {
  applyAVPlaneReservoirCapacityTransactionVariantV1,
  AV_PLANE_RESERVOIR_CAPACITY_TRANSACTION_VARIANTS_V1,
  runAVPlaneReservoirCapacityTransactionBenchV1,
  type AVPlaneReservoirCapacityTransactionVariantIdV1,
...
const OUTPUT_PATH =
  "data/mechanics2/visuals/av-plane-reservoir-capacity-transaction-pv-review.svg" as const;
...
const report = runAVPlaneReservoirCapacityTransactionBenchV1();
  ...
  return {
    ...
    series: [
      ...
      },
      {
        ...
        color: "#22c55e",
        samples: runLeftHeartSubsystemV2(
          applyAVPlaneReservoirCapacityTransactionVariantV1(params, bestVariant),
        ).finalBeatSamples,
      },
    ],
  };
...
function variantById(
  ...
  const variant = AV_PLANE_RESERVOIR_CAPACITY_TRANSACTION_VARIANTS_V1.find((candidate) =>
...
function renderSvg(
  ...
  bestVariantId: AVPlaneReservoirCapacityTransactionVariantIdV1,
): string {
  ...
  <text x="28" y="30" fill="#e5e7eb" font-family="Arial, sans-serif" font-size="18" font-weight="700">AV-plane reservoir capacity transaction PV review</text>
