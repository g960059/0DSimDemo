...
svg.push(`<text x="34" y="58" fill="#9ca3af" font-family="Inter,Arial,sans-serif" font-size="13">Strict blood-volume LA PV: MV opening must move down/left below the reservoir chord, with PV tangent C1 and s/e/a-prime proxy checks.</text>`);
...
svg.push(`<text x="1472" y="67" fill="#cbd5e1" font-family="Inter,Arial,sans-serif" font-size="12">MV closure</text>`);
svg.push(`<path d="M1455,79 L1465,89 M1465,79 L1455,89" stroke="#ef4444" stroke-width="1.6"/>`);
svg.push(`<text x="1472" y="89" fill="#cbd5e1" font-family="Inter,Arial,sans-serif" font-size="12">PV tangent kink marker</text>`);
...
function renderPressure(
  ...
  const samples = panel.bestSmoothCore;
  ...
  axis(out, x, y, w, h, "best smooth pressure");
  out.push(`<path d="${pathForTrace(samples, sx, sy, "lapMmHg")}" fill="none" stroke="#eab308" stroke-width="2.2" opacity="0.9"/>`);
...
function renderPrime(
  ...
  axis(out, x, y, w, h, "best smooth s/e/a'");
