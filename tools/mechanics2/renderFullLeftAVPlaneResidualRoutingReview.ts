...
function renderPressure(
  ...
  const samples = panel.bestFullResidual;
  ...
  axis(out, x, y, w, h, "best full pressure");
  out.push(`<path d="${pathForTrace(samples, sx, sy, "lapMmHg")}" fill="none" stroke="#a855f7" stroke-width="2.2" opacity="0.9"/>`);
...
function renderPrime(
  ...
  axis(out, x, y, w, h, "best full s/e/a'");
