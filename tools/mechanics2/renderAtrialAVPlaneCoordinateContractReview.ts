...
const bestVariant = ATRIAL_AV_PLANE_COORDINATE_CONTRACT_VARIANTS_V1.find((variantConfig) =>
  variantConfig.variantId === report.summary.bestWallWorkVariantId
)!;
...
svg.push(`<text x="34" y="82" fill="#9ca3af" font-family="Inter,Arial,sans-serif" font-size="12">best wall-work residual: ${report.summary.bestWallWorkVariantId}, source ${report.summary.bestWallWorkSourceSurfacePass}/7, topology ${report.summary.bestWallWorkTopologyPass}/7, source+topology ${report.summary.bestWallWorkSourcePreservingTopologyPass}/7, MVF ${report.summary.bestWallWorkMvfCleanCount}/7</text>`);
...
svg.push(`<text x="958" y="84" fill="#f97316" font-family="Inter,Arial,sans-serif" font-size="13">best wall-work residual</text>`);
