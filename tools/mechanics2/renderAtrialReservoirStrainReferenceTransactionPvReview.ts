...
import {
  applyAtrialReservoirStrainReferenceTransactionVariantV1,
  ATRIAL_RESERVOIR_STRAIN_REFERENCE_TRANSACTION_VARIANTS_V1,
  runAtrialReservoirStrainReferenceTransactionBenchV1,
  type AtrialReservoirStrainReferenceTransactionVariantIdV1,
...
const OUTPUT_PATH =
  "data/mechanics2/visuals/atrial-reservoir-strain-reference-transaction-pv-review.svg" as const;
...
const report = runAtrialReservoirStrainReferenceTransactionBenchV1();
  ...
  return {
    ...
    series: [
      ...
      },
      {
        ...
        color: "#22c55e",
        samples: runLeftHeartSubsystemV2(
          applyAtrialReservoirStrainReferenceTransactionVariantV1(params, bestVariant),
        ).finalBeatSamples,
      },
    ],
  };
...
function variantById(
  ...
  const variant = ATRIAL_RESERVOIR_STRAIN_REFERENCE_TRANSACTION_VARIANTS_V1.find((candidate) =>
...
function renderSvg(
  ...
  bestVariantId: AtrialReservoirStrainReferenceTransactionVariantIdV1,
): string {
  ...
  <text x="28" y="30" fill="#e5e7eb" font-family="Arial, sans-serif" font-size="18" font-weight="700">Atrial reservoir strain-reference transaction PV review</text>
