...
describe("myocardium Phase 5C-G same-closure source-provider audit", () => {
  ...
  it("allows the Phase 5S Land operating-point calibration diagnostic diff", () => {
    const input = fixture();
    input.changedFilePaths = [
      "__tests__/myocardiumPhase5CPositiveControlTriageAudit.test.ts",
      "__tests__/myocardiumPhase5CSameClosureSourceProviderAudit.test.ts",
  ...
  it("allows the Phase 5T education-tool DoD checkpoint diff", () => {
    const input = fixture();
    input.changedFilePaths = [
      "__tests__/myocardiumPhase5CSameClosureSourceProviderAudit.test.ts",
  ...
  it("allows the Phase 5U developer-only LV Land runtime-flag RFC diff", () => {
    const input = fixture();
    input.changedFilePaths = [
      "__tests__/myocardiumPhase5CSameClosureSourceProviderAudit.test.ts",
  ...
  it("allows the Phase 5W developer-only LV Land envelope diff", () => {
    const input = fixture();
    input.changedFilePaths = [
      "__tests__/myocardiumPhase5CSameClosureSourceProviderAudit.test.ts",
