...
import {
  ...
  runMainWireValveResearchBracketNumericalRobustnessEnvelopeV1,
} from "@/tools/scientific/mainWireValveResearchBracketNumericalRobustnessEnvelopeV1";

describe("main-wire valve research bracket numerical robustness envelope V1", () => {
  it("completes one 2 ms beat for healthy and all eight severe brackets on the analytic path", () => {
    const summary = runMainWireValveResearchBracketNumericalRobustnessEnvelopeV1(0.002);
