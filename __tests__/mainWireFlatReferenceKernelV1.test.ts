    ...
    expect(flatNumericalStateBuffersEqualV1(
      {
        ...
        nullableStrings: after.nullableStrings,
        nullableStringsPresent: after.nullableStringsPresent,
        optionalRecordPresent: after.optionalRecordPresent,
        boundedArrayLengths: after.boundedArrayLengths,
      ...
      },
      {
        ...
        nullableStrings: before.nullableStrings,
        nullableStringsPresent: before.nullableStringsPresent,
        optionalRecordPresent: before.optionalRecordPresent,
        boundedArrayLengths: before.boundedArrayLengths,
