...
export type SimSample = {
  ...
  LAWallLambda?: number;
  LAWallLambdaWithoutAvPlane?: number;
  LAWallLambdaAvPlaneDelta?: number;
  LAWallEngineeringStrain?: number;
  LAWallEngineeringStrainWithoutAvPlane?: number;
  LAWallEngineeringStrainAvPlaneDelta?: number;
  ...
  RAWallLambda?: number;
  RAWallLambdaWithoutAvPlane?: number;
  RAWallLambdaAvPlaneDelta?: number;
  RAWallEngineeringStrain?: number;
  RAWallEngineeringStrainWithoutAvPlane?: number;
  RAWallEngineeringStrainAvPlaneDelta?: number;
  ...
  dP_TV: number;
  dP_PV: number;
  MV_qNextPreDiode?: number;
  MV_qNextPostDiode?: number;
  MV_qNextPreFlowClamp?: number;
  MV_qNextPostFlowClamp?: number;
  MV_qDotPreDiode?: number;
  MV_qDotPostDiode?: number;
  MV_qDotPreFlowClamp?: number;
  MV_qDotRaw?: number;
  MV_qDotPost?: number;
  ...
  MV_acceptedBoundaryApplied01?: number;
  MV_acceptedBoundaryQNext?: number;
  MV_acceptedBoundaryPressureGradientMmHg?: number;
  MV_acceptedBoundaryQDotRaw?: number;
  MV_acceptedBoundaryQDotPost?: number;
  MV_acceptedBoundaryQDotClampHit01?: number;
  MV_acceptedBoundaryQDotClampImpulse?: number;
  ...
  AoV_acceptedBoundaryApplied01?: number;
  AoV_acceptedBoundaryQNext?: number;
  AoV_acceptedBoundaryPressureGradientMmHg?: number;
  AoV_acceptedBoundaryQDotRaw?: number;
  AoV_acceptedBoundaryQDotPost?: number;
  AoV_acceptedBoundaryQDotClampHit01?: number;
  AoV_acceptedBoundaryQDotClampImpulse?: number;
  AoV_acceptedBoundaryDiodeImpulse?: number;
  AoV_acceptedBoundaryComplementarityResidualMlPerSec?: number;
  AoV_acceptedBoundaryIterationCount?: number;
  AoV_acceptedBoundaryValveState01?: number;
  AoV_acceptedBoundaryAreaRatio?: number;
  AoV_acceptedBoundaryStatefulV2Applied01?: number;
  AoV_acceptedBoundaryStatefulV2Closing01?: number;
  AoV_acceptedBoundaryStatefulV2LossScale?: number;
  AoV_acceptedBoundaryStatefulV2InertanceScale?: number;
  TV_qNextPreDiode?: number;
  TV_qNextPostDiode?: number;
  TV_qNextPreFlowClamp?: number;
  TV_qNextPostFlowClamp?: number;
  TV_qDotPreDiode?: number;
  TV_qDotPostDiode?: number;
  TV_qDotPreFlowClamp?: number;
  TV_qDotRaw?: number;
  TV_qDotPost?: number;
  ...
  TV_acceptedBoundaryApplied01?: number;
  TV_acceptedBoundaryQNext?: number;
  TV_acceptedBoundaryPressureGradientMmHg?: number;
  TV_acceptedBoundaryQDotRaw?: number;
  TV_acceptedBoundaryQDotPost?: number;
  TV_acceptedBoundaryQDotClampHit01?: number;
  TV_acceptedBoundaryQDotClampImpulse?: number;
  ...
  PV_qNextPostFlowClamp?: number;
  PV_qDotPreDiode?: number;
  PV_qDotPostDiode?: number;
  PV_qDotPreFlowClamp?: number;
  PV_qDotRaw?: number;
  PV_qDotPost?: number;
  ...
  PV_acceptedBoundaryApplied01?: number;
  PV_acceptedBoundaryQNext?: number;
  PV_acceptedBoundaryPressureGradientMmHg?: number;
  PV_acceptedBoundaryQDotRaw?: number;
  PV_acceptedBoundaryQDotPost?: number;
  PV_acceptedBoundaryQDotClampHit01?: number;
  PV_acceptedBoundaryQDotClampImpulse?: number;
  PV_acceptedBoundaryDiodeImpulse?: number;
  PV_acceptedBoundaryComplementarityResidualMlPerSec?: number;
  PV_acceptedBoundaryIterationCount?: number;
  PV_acceptedBoundaryValveState01?: number;
  PV_acceptedBoundaryAreaRatio?: number;
  PV_acceptedBoundaryStatefulV2Applied01?: number;
  PV_acceptedBoundaryStatefulV2Closing01?: number;
  PV_acceptedBoundaryStatefulV2LossScale?: number;
  PV_acceptedBoundaryStatefulV2InertanceScale?: number;
