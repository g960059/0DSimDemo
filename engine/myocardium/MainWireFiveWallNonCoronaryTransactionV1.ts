...
export function checkpointMainWireFiveWallNonCoronaryV1<TWallState>(
  ...
  const checkpoint = {
    ...
    calcium: cloneFiveWallCalciumAcceptedStateV1(state.calcium),
  };
...
export function restoreMainWireFiveWallNonCoronaryV1<TWallState>(
  ...
  if (
    ...
    || checkpoint.revision !== checkpoint.calcium.revision
    ...
    || checkpoint.acceptedTimeSec !== checkpoint.calcium.acceptedTimeSec
  ...
  const checkpointCalcium = cloneFiveWallCalciumAcceptedStateV1(
    checkpoint.calcium,
  );
  ...
  return acceptedPair(revision, circulation, mechanics, calcium);
}
...
>(
  ...
  const translatedCirculation = createInitialNonCoronaryCirculationStateV1({
    ...
    runtime: input.runtime,
    fixedTotalBloodVolumeMl: source.circulation.totalBloodVolumeMl,
