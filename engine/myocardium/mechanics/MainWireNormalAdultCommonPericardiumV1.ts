...
export function createMainWireNormalAdultCommonPericardiumV1(
  ...
  ) + wallMaterialVolumesM3.reduce((sum, value) => sum + value, 0);
  ...
  const referenceHeartVolumeM3 = caseId
    === "global-capacity-vh0-430ml-positive-control"
    ? policy.fixedPositiveControls.globalCapacity.referenceHeartVolumeMl * 1e-6
  ...
  return Object.freeze({
    ...
    parameters: Object.freeze({
      ...
      prescribedPressureOffsetPa: policy.prescribedPressureOffsetPa,
    }),
