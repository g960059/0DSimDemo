...
export type MainWireIntegratedLanePresetV1 = Awaited<ReturnType<
  typeof createMainWireIntegratedLanePresetV1
>>;

/**
 * Production-owned fixed coronary + regular-sinus + HMII 9000 lane preset.
 * The profile is experimental and its identity strings say that explicitly.
 */
export async function createMainWireIntegratedLanePresetV1() {
...
export function mainWireIntegratedLaneCheckpointContextV1(
  ...
  return Object.freeze({
    ...
    coronaryPrior: preset.coronaryStepInput.coronaryPrior,
    collapseHydraulics: preset.coronaryStepInput.collapseHydraulics,
    impMechanism: preset.coronaryStepInput.impMechanism,
    shorteningImpPrior: preset.coronaryStepInput.shorteningImpPrior,
    coronaryAutoregulationBinding:
      state.coronary.coronaryAutoregulationBinding,
    rhythm: Object.freeze({ configuration: preset.rhythm.configuration }),
    dynamicMechanicalSupportProfile: preset.profile,
