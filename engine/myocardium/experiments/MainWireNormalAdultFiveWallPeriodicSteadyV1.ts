...
import {
  resolveMainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelArmV1,
...
export type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHeartRateLawResearchRunV1 =
  Readonly<
    Omit<
      ...
      | "claim"
    > & {
      configurationRole: "fixed-v10-reference-non-calcium-matched-alpha-saturating-heart-rate-law-arm";
      referenceNonCalciumAssembly: typeof MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1;
      saturatingHeartRateLawProfile: MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1;
      activeDesign:
        | Readonly<{
        ...
        | Readonly<{
            ...
            experimentRole: "fixed-prior-endpoint-sensitivity-not-an-optimizer";
            mainDesign: false;
...
export type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHr90AtrioventricularDelayBracketResearchRunV1 =
  Readonly<
    Omit<
      MainWireNormalAdultFiveWallAorticOutflowV10HeartRateCalciumHypothesisResearchRunV1,
      | "configurationRole"
      ...
      | "claim"
    > & {
      configurationRole: "fixed-v10-reference-non-calcium-matched-alpha-saturating-hr90-atrioventricular-delay-bracket-arm";
      referenceNonCalciumAssembly: typeof MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1;
      baseSaturatingHeartRateLawProfile: MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1;
      atrioventricularDelayBracketProfile: MainWireVentricularCalciumMatchedAlphaSaturatingHr90AtrioventricularDelayProfileV1;
      claim: Readonly<{
        sourceResearchRunnerOnly: true;
        independentCanonicalColdStart: true;
        warmStartApplied: false;
        ...
        baseSaturatingHeartRateLawProfileHeldExactly: true;
        controlArmReusesBaseCalciumParamsByIdentity: boolean;
...
export type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismResearchRunV1 =
  Readonly<
    Omit<
      ...
      | "claim"
    > & {
      configurationRole: "fixed-v10-matched-alpha-saturating-hr90-opening-load-mechanism-arm";
      openingLoadMechanismArm: MainWireAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismArmV1;
      claim: Readonly<{
        sourceResearchRunnerOnly: true;
        independentCanonicalColdStart: true;
        warmStartApplied: false;
        ...
        onlySystemicResistanceRuntimeAxisEligibleToDiffer: true;
        onlyCanonicalAdditionalSvVcVolumeEligibleToDiffer: true;
        systemicResistanceChanged: boolean;
        stressedVenousVolumeChanged: boolean;
...
export type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelResearchRunV1 =
  Readonly<
    Omit<
      MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeResearchRunV1,
      "configurationRole" | "claim"
    > & {
      configurationRole: "fixed-v10-matched-alpha-saturating-robustness-envelope-48s-sentinel-arm";
      fixedHorizonSentinelArm: MainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelArmV1;
      executionPolicy: Readonly<{
        policyId: "matched-alpha-saturating-robustness-envelope-fixed-48s-cycle-4000-sentinel-v1";
      ...
      claim: Readonly<{
        ...
        arbitraryEnvelopeArmInputExposed: false;
        arbitraryNumericFactorInputExposed: false;
        ...
        acceptedStateOrCheckpointTopologyChanged: false;
        exactProtocolIdentityIncludesCalciumParamsAndAllFiveFactors: true;
        fixedPhysicalHorizonAuditCompleted: true;
...
type MainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyLoadSelectionV1 =
  Readonly<{
    circulatoryLoadPointId:
...
/**
 * Private execution boundary for experiments that use a fixed, catalog-resolved
 * calcium profile and load selection around the V10 reference assembly.
 */
function runMainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyV1(
  options: MainWireNormalAdultFiveWallAorticOutflowResearchOptionsV1,
  calciumDriveParams: FiveWallNormalCalciumDriveParamsV1,
  expectedHeartRateBpm: number,
  loadSelection: MainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyLoadSelectionV1,
...
type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingResolvedProfileV1 =
  Readonly<{
    saturatingHeartRateLawProfile:
      MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1;
    activeDesign:
      MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHeartRateLawResearchRunV1["activeDesign"];
    calciumDriveParams: FiveWallNormalCalciumDriveParamsV1;
  }>;

function resolveMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingProfileV1(
  profileId: MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileIdV1,
): MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingResolvedProfileV1 {
  const arm =
    resolveMainWireAorticOutflowV10MatchedAlphaSaturatingHeartRateLawArmV1(
      profileId,
    );
  ...
  const activeDesign =
    saturatingHeartRateLawProfile.designRole === "main-four-heart-rate-design"
      ? Object.freeze({
          designRole: "main-four-heart-rate-design" as const,
          experimentRole: "primary-fixed-heart-rate-trend-test" as const,
          mainDesign: true as const,
          priorSensitivityDesign: false as const,
        })
      : Object.freeze({
          designRole: "endpoint-prior-sensitivity" as const,
          experimentRole:
            "fixed-prior-endpoint-sensitivity-not-an-optimizer" as const,
          mainDesign: false as const,
          priorSensitivityDesign: true as const,
        });
  if (
    arm.armId !== profileId ||
    arm.calciumProfileId !== profileId ||
    arm.designRole !== saturatingHeartRateLawProfile.designRole ||
    arm.heartRateBpm !== saturatingHeartRateLawProfile.heartRateBpm ||
    arm.dimensionlessRateCoefficient !==
      saturatingHeartRateLawProfile.dimensionlessRateCoefficient ||
    arm.cycleLengthSec !== saturatingHeartRateLawProfile.cycleLengthSec ||
    arm.circulatoryLoadPointId !== "baseline" ||
    arm.stressedVenousVolumePointId !== "baseline" ||
    calciumDriveParams.cycleLengthSec !==
      saturatingHeartRateLawProfile.cycleLengthSec ||
    60 / calciumDriveParams.cycleLengthSec !==
      saturatingHeartRateLawProfile.heartRateBpm ||
    calciumDriveParams.atrioventricularDelaySec !==
      saturatingHeartRateLawProfile.atrioventricularDelaySec ||
    calciumDriveParams.ventricular.riseTimeConstantSec !==
      saturatingHeartRateLawProfile.ventricularRiseTimeConstantSec ||
    calciumDriveParams.ventricular.decayTimeConstantSec !==
      saturatingHeartRateLawProfile.ventricularDecayTimeConstantSec ||
    calciumDriveParams.ventricular.electricalToCalciumDelaySec !==
      saturatingHeartRateLawProfile
        .ventricularElectricalToCalciumDelaySec ||
    calciumDriveParams.ventricular.diastolicCalciumUM !==
      saturatingHeartRateLawProfile.ventricularDiastolicCalciumUM ||
    calciumDriveParams.ventricular.diastolicCalciumUM
      + calciumDriveParams.ventricular.peakAmplitudeUM !==
      saturatingHeartRateLawProfile.ventricularPeakCalciumUM ||
    activeDesign.designRole !== saturatingHeartRateLawProfile.designRole ||
    (activeDesign.mainDesign &&
      saturatingHeartRateLawProfile.dimensionlessRateCoefficient !== 0.4) ||
    (activeDesign.priorSensitivityDesign &&
      (saturatingHeartRateLawProfile.dimensionlessRateCoefficient === 0.4 ||
        (saturatingHeartRateLawProfile.heartRateBpm !== 50 &&
          saturatingHeartRateLawProfile.heartRateBpm !== 90)))
  ) {
    throw new Error(
      "V10 matched-alpha saturating heart-rate law profile/parameter/design identity mismatch",
    );
  }
  return Object.freeze({
    saturatingHeartRateLawProfile,
...
function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingResolvedProfileV1(
  options: MainWireNormalAdultFiveWallAorticOutflowResearchOptionsV1,
  resolvedProfile: MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingResolvedProfileV1,
): MainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyExecutionV1 {
  const execution =
    runMainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyV1(
      options,
      resolvedProfile.calciumDriveParams,
      resolvedProfile.saturatingHeartRateLawProfile.heartRateBpm,
      MAIN_WIRE_AORTIC_OUTFLOW_V10_HEART_RATE_CALCIUM_BASELINE_LOAD_V1,
      Object.freeze({
        protocolIdentity:
          "V10 matched-alpha saturating heart-rate law protocol identity mismatch",
        nonCalciumAssemblyIdentity:
          "V10 matched-alpha saturating heart-rate law non-calcium assembly identity mismatch",
        exactProtocolReadback:
          "V10 matched-alpha saturating heart-rate law exact protocol readback mismatch",
      }),
    );
  if (
    execution.reference !==
    ...
    throw new Error(
      "V10 matched-alpha saturating heart-rate law reference assembly identity mismatch",
    );
  }
  return execution;
}
...
/**
 * Fixed-profile saturating heart-rate law on the V10 reference non-Ca
 * assembly. Catalog design identity is returned separately from caller-chosen
 * exact integration resolution and execution beat limit.
 */
export function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHeartRateLawResearchV1(
  options: MainWireNormalAdultFiveWallAorticOutflowResearchOptionsV1,
  profileId: MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileIdV1,
): MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHeartRateLawResearchRunV1 {
  assertExactAorticOutflowResearchOptions(options);
  const resolvedProfile =
    resolveMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingProfileV1(
      profileId,
    );
  const {
    saturatingHeartRateLawProfile,
  ...
  const {
    ...
    periodicResult,
    exactAssemblyAudit,
  } = runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingResolvedProfileV1(
    options,
    resolvedProfile,
  );
  return Object.freeze({
    configurationRole:
      "fixed-v10-reference-non-calcium-matched-alpha-saturating-heart-rate-law-arm" as const,
    referenceNonCalciumAssembly:
      MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1,
    saturatingHeartRateLawProfile,
    activeDesign,
    ...
    claim: Object.freeze({
      ...
      genericParameterPatchAccepted: false as const,
      fixedSaturatingHeartRateLawProfileOnly: true as const,
      ...
      activeDesignMembershipCheckedAgainstCatalog: true as const,
      catalogArmExecutionDefaultsReturnedAsApplied: false as const,
      valveDiseaseBracketApplied: false as const,
      referenceAssemblyDerivedFromCandidateV10: true as const,
      fullV10CandidateIdentityRetained: false as const,
      V10ReferenceNonCalciumAssemblyHeldExactly: true as const,
      ...
      ventricularElectricalToCalciumDelayHeldAtSec: 0.012 as const,
      atrioventricularDelayHeldAtSec: 0.12 as const,
      onlyVentricularRiseAndDecayTimeConstantsEligibleToDifferFromFixedHeartRateControl:
        true as const,
      hr60MainArmReusesAbsoluteTimeAlphaFitControlParamsExactly: true as const,
      oldLandCoppiniSourceTraceProfileReturned: false as const,
      oldAtrioventricularDelayProfileReturned: false as const,
      circulatoryLoadHeldAtBaseline: true as const,
      bloodVolumeHeldAtBaseline: true as const,
...
/**
 * Closed HR90 AV electrical-onset-delay bracket on the matched-alpha
 * saturating a=0.40 profile and fixed V10 reference non-Ca assembly. The
 * profile ID is the only experimental input beyond exact integration options.
 */
export function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHr90AtrioventricularDelayBracketResearchV1(
  options: MainWireNormalAdultFiveWallAorticOutflowResearchOptionsV1,
  ...
  assertExactAorticOutflowResearchOptions(options);
  const baseSaturatingHeartRateLawProfile =
    resolveMainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1(
      "matched-alpha-saturating-hr-law-a040-hr-90",
    );
  const baseCalciumDriveParams =
    resolveMainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawParamsV1(
      "matched-alpha-saturating-hr-law-a040-hr-90",
    );
  const atrioventricularDelayBracketProfile =
    resolveMainWireVentricularCalciumMatchedAlphaSaturatingHr90AtrioventricularDelayProfileV1(
      profileId,
    );
  const calciumDriveParams =
  ...
  const controlArm =
    atrioventricularDelayBracketProfile.atrioventricularDelaySec === 0.12;
  const differingParamKeys = Array.from(
    new Set([
      ...Object.keys(baseCalciumDriveParams),
      ...Object.keys(calciumDriveParams),
    ]),
  )
    .filter(
      (key) =>
        (baseCalciumDriveParams as Readonly<Record<string, unknown>>)[key] !==
        (calciumDriveParams as Readonly<Record<string, unknown>>)[key],
    )
    .sort();
  if (
    atrioventricularDelayBracketProfile.profileId !== profileId ||
    atrioventricularDelayBracketProfile.baseSaturatingHeartRateLawProfileId !==
      baseSaturatingHeartRateLawProfile.profileId ||
    atrioventricularDelayBracketProfile.heartRateBpm !== 90 ||
    atrioventricularDelayBracketProfile.dimensionlessRateCoefficient !== 0.4 ||
    atrioventricularDelayBracketProfile.cycleLengthSec !==
      baseSaturatingHeartRateLawProfile.cycleLengthSec ||
    calciumDriveParams.cycleLengthSec !==
      baseSaturatingHeartRateLawProfile.cycleLengthSec ||
    60 / calciumDriveParams.cycleLengthSec !== 90 ||
    calciumDriveParams.atrioventricularDelaySec !==
      atrioventricularDelayBracketProfile.atrioventricularDelaySec ||
    calciumDriveParams.atrial !== baseCalciumDriveParams.atrial ||
    calciumDriveParams.ventricular !== baseCalciumDriveParams.ventricular ||
    (controlArm && calciumDriveParams !== baseCalciumDriveParams) ||
    (!controlArm &&
      (differingParamKeys.length !== 2 ||
        differingParamKeys[0] !== "atrioventricularDelaySec" ||
        differingParamKeys[1] !== "parameterSetId"))
  ) {
    throw new Error(
      "V10 matched-alpha saturating HR90 atrioventricular-delay profile/parameter identity mismatch",
    );
  }
  const {
    reference,
    ...
    Object.freeze({
      protocolIdentity:
        "V10 matched-alpha saturating HR90 atrioventricular-delay protocol identity mismatch",
      nonCalciumAssemblyIdentity:
        "V10 matched-alpha saturating HR90 atrioventricular-delay non-calcium assembly identity mismatch",
      exactProtocolReadback:
        "V10 matched-alpha saturating HR90 atrioventricular-delay exact protocol readback mismatch",
    }),
  );
  if (
    reference !==
    ...
    throw new Error(
      "V10 matched-alpha saturating HR90 atrioventricular-delay reference assembly identity mismatch",
    );
  }
  return Object.freeze({
    configurationRole:
      "fixed-v10-reference-non-calcium-matched-alpha-saturating-hr90-atrioventricular-delay-bracket-arm" as const,
    referenceNonCalciumAssembly:
      MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1,
    ...
    claim: Object.freeze({
      ...
      exactResearchOptionsLimitedToDtAndMaximumBeatCount: true as const,
      genericParameterPatchAccepted: false as const,
      fixedThreePointAtrioventricularDelayProfileOnly: true as const,
      arbitraryNumericAtrioventricularDelayInputExposed: false as const,
      valveDiseaseBracketApplied: false as const,
      referenceAssemblyDerivedFromCandidateV10: true as const,
      fullV10CandidateIdentityRetained: false as const,
      V10ReferenceNonCalciumAssemblyHeldExactly: true as const,
      ...
      baseSaturatingHeartRateLawProfileHeldExactly: true as const,
      controlArmReusesBaseCalciumParamsByIdentity:
        controlArm && calciumDriveParams === baseCalciumDriveParams,
      ...
      literatureUsedForDirectionOnly: true as const,
      parameterSearchOrFitting: false as const,
      clinicalValidationClaimed: false as const,
      canonicalAdoptionEstablished: false as const,
    }),
...
/**
 * Closed HR90 opening-load mechanism ablation. The arm ID selects only the
 * established systemic-resistance and stressed-volume catalog coordinates;
 * calcium, mechanics, valve, compliance, and Tref identities remain fixed.
 */
export function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismResearchV1(
  options: MainWireNormalAdultFiveWallAorticOutflowResearchOptionsV1,
  ...
  assertExactAorticOutflowResearchOptions(options);
  const openingLoadMechanismArm =
    resolveMainWireAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismArmV1(
      armId,
    );
  const saturatingHeartRateLawProfile =
    resolveMainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1(
      openingLoadMechanismArm.calciumProfileId,
    );
  const calciumDriveParams =
    resolveMainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawParamsV1(
      openingLoadMechanismArm.calciumProfileId,
  ...
  if (
    saturatingHeartRateLawProfile.profileId !==
      openingLoadMechanismArm.calciumProfileId ||
    saturatingHeartRateLawProfile.heartRateBpm !==
      openingLoadMechanismArm.heartRateBpm ||
    saturatingHeartRateLawProfile.dimensionlessRateCoefficient !==
      openingLoadMechanismArm.dimensionlessRateCoefficient ||
    calciumDriveParams.cycleLengthSec !==
      saturatingHeartRateLawProfile.cycleLengthSec ||
    60 / calciumDriveParams.cycleLengthSec !== 90 ||
    ...
    throw new Error(
      "V10 matched-alpha saturating HR90 opening-load calcium identity mismatch",
    );
  }
  const {
    reference,
    ...
    calciumDriveParams,
    90,
    openingLoadMechanismArm,
    Object.freeze({
      protocolIdentity:
        "V10 matched-alpha saturating HR90 opening-load protocol identity mismatch",
      nonCalciumAssemblyIdentity:
        "V10 matched-alpha saturating HR90 opening-load assembly identity mismatch",
      exactProtocolReadback:
        "V10 matched-alpha saturating HR90 opening-load exact protocol readback mismatch",
    }),
  );
  if (
    reference !==
    ...
    assembly.circulatoryLoadPoint.systemicResistanceScaleFromBaseline !==
      openingLoadMechanismArm.systemicResistanceScaleFromBaseline ||
    ...
    throw new Error(
      "V10 matched-alpha saturating HR90 opening-load catalog resolution mismatch",
    );
  }
  return Object.freeze({
    configurationRole:
      "fixed-v10-matched-alpha-saturating-hr90-opening-load-mechanism-arm" as const,
    referenceNonCalciumAssembly:
      MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1,
    saturatingHeartRateLawProfile,
    openingLoadMechanismArm,
    ...
    claim: Object.freeze({
      ...
      exactResearchOptionsLimitedToDtAndMaximumBeatCount: true as const,
      genericParameterPatchAccepted: false as const,
      fixedFourArmOpeningLoadFactorialOnly: true as const,
      arbitraryNumericLoadInputExposed: false as const,
      valveDiseaseBracketApplied: false as const,
      referenceAssemblyDerivedFromCandidateV10: true as const,
      fullV10CandidateIdentityRetained: false as const,
      V10ReferenceNonLoadAssemblyHeldExactly: true as const,
      heartRateHeldAtBpm: 90 as const,
      matchedAlphaSaturatingRateCoefficientHeldAt: 0.4 as const,
      calciumAndAtrioventricularTimingHeldExactly: true as const,
      mechanicsProviderHeldExactly: true as const,
      valveAndPressureStationAssemblyHeldExactly: true as const,
      complianceAndTrefAssemblyHeldExactly: true as const,
      ...
      systemicResistanceChanged:
        openingLoadMechanismArm.systemicResistanceLevel !== "baseline",
      stressedVenousVolumeChanged:
        openingLoadMechanismArm.stressedVenousVolumeLevel !== "baseline",
...
type MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeResolvedArmExecutionV1 =
  Readonly<
    MainWireNormalAdultFiveWallAorticOutflowV10ReferenceAssemblyExecutionV1 & {
      robustnessEnvelopeArm: MainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeArmV1;
      saturatingHeartRateLawProfile: MainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawProfileV1;
...
function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeResolvedArmV1(
  ...
  const { reference, assembly, periodicResult } = execution;
  if (
    reference !==
      MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1 ||
    assembly.circulatoryLoadPoint.pointId !==
...
/**
 * Exact 48-second, cycle/4000 execution of one arm in the frozen limiting
 * union. The sole public input is a predeclared sentinel arm ID; callers cannot
 * alter the resolution, horizon, early-stop policy, or any physical factor.
 */
export function runMainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelResearchV1(
  sentinelArmId: MainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelArmIdV1,
): MainWireNormalAdultFiveWallAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelResearchRunV1 {
  if (arguments.length !== 1 || typeof sentinelArmId !== "string") {
    throw new Error(
      "saturating robustness fixed-horizon sentinel accepts one frozen sentinel arm ID and no execution options",
    );
  }
  const fixedHorizonSentinelArm =
    resolveMainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelArmV1(
      sentinelArmId,
    );
  ...
  if (
    ...
    throw new Error(
      `${sentinelArmId} did not complete the exact period-1 48-second cycle/4000 sentinel policy`,
    );
  }
  return Object.freeze({
    configurationRole:
      "fixed-v10-matched-alpha-saturating-robustness-envelope-48s-sentinel-arm" as const,
    referenceNonCalciumAssembly:
      MAIN_WIRE_AORTIC_OUTFLOW_V10_MATCHED_ALPHA_SATURATING_HEART_RATE_LAW_REFERENCE_NON_CALCIUM_ASSEMBLY_V1,
    robustnessEnvelopeArm,
    ...
    claim: Object.freeze({
      ...
      arbitraryEnvelopeArmInputExposed: false as const,
      arbitraryNumericFactorInputExposed: false as const,
      ...
      exactProtocolIdentityIncludesCalciumParamsAndAllFiveFactors:
        true as const,
      fixedPhysicalHorizonAuditCompleted: true as const,
