...
/**
 * Fixed successor construction selected after the Standard69 factorized
 * pulmonary-root study. Only PA_PArt momentum memory is removed. The source
 * linear/quadratic loss, pressure-volume laws, pressure stations, valve laws,
 * ventricular material, calcium owner, and all other branches remain intact.
 *
 * The accepted PA_PArt flow remains in the existing checkpoint layout as an
 * exact readback, but L=0 makes it causally irrelevant to the following step.
 */
