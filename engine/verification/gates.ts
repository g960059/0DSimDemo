...
export function collectNormalBaselineGates(measurement: SteadyMeasurement): GateResult[] {
  ...
  return [
    ...
    upperBoundGate("lv-filling-edge-excess", "LV filling-edge path excess", leftFilling.lvFillingEdgeExcess, 1.25, 1.10),
    upperBoundGate("lv-filling-edge-curvature", "LV filling-edge curvature", leftFilling.lvFillingEdgeCurvature, 2.4, 1.4),
    upperBoundGate("lv-filling-edge-reversals", "LV filling-edge pressure reversals", leftFilling.lvFillingEdgeReversalCount, 2.5, 1),
