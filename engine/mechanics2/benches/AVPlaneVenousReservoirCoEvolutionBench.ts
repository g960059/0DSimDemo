...
export const AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_REPORT_ID_V1 =
  "av-plane-venous-reservoir-coevolution-report-v1" as const;

export type AVPlaneVenousReservoirCoEvolutionVariantIdV1 =
  | "compliance-node-no-avplane"
  | "venous-stretch-gain10-flow020"
  | "venous-stretch-gain12-flow030"
  | "venous-stretch-gain16-flow030"
  | "venous-stretch-gain16-flow045"
  | "venous-stretch-gain20-flow045"
  | "venous-capacity-gain12-flow030"
  | "venous-capacity-gain16-flow045"
  | "venous-stretch-gain16-boost04-flow030"
  | "venous-stretch-gain16-work1-flow030"
  | "venous-stretch-gain16-suction1-flow030"
  | "venous-stretch-gain16-suction2-flow030"
  | "venous-capacity-gain16-suction1-flow030"
  | "venous-capacity-gain24-flow060"
  | "venous-capacity-gain32-flow060"
  | "venous-capacity-gain24-suction1-flow060"
  | "venous-capacity-gain32-suction2-flow060";

type GeometryEffectV1 = "capacity" | "stretch";

export type AVPlaneVenousReservoirCoEvolutionVariantV1 = {
  readonly variantId: AVPlaneVenousReservoirCoEvolutionVariantIdV1;
...
export type AVPlaneVenousReservoirCoEvolutionReportV1 = {
  readonly reportId: typeof AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_REPORT_ID_V1;
  readonly gateId: "avPlaneVenousReservoirCoEvolutionV1";
  readonly mode: "left-heart-av-plane-venous-reservoir-coevolution-no-runtime";
  readonly variants: readonly AVPlaneVenousReservoirCoEvolutionVariantV1[];
  ...
  readonly summary: {
    ...
    readonly bestVariantId: AVPlaneVenousReservoirCoEvolutionVariantIdV1;
    ...
    readonly maxSourceSurfaceVariantId: AVPlaneVenousReservoirCoEvolutionVariantIdV1;
    readonly maxLobeQualityPass: number;
    readonly maxLobeQualityVariantId: AVPlaneVenousReservoirCoEvolutionVariantIdV1;
    readonly maxDtHalfContractPass: number;
    readonly maxDtHalfContractVariantId: AVPlaneVenousReservoirCoEvolutionVariantIdV1;
    readonly dominantLobeFailureCounts: Record<DominantLobeFailureClassV1, number>;
  };
  readonly decision: {
    readonly avPlaneVenousReservoirCoEvolutionStatus:
      | "av-plane-venous-reservoir-coevolution-signal"
      | "av-plane-venous-reservoir-coevolution-mixed"
      | "av-plane-venous-reservoir-coevolution-blocked";
...
export const AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_VARIANTS_V1:
readonly AVPlaneVenousReservoirCoEvolutionVariantV1[] = [
  variant("compliance-node-no-avplane", 0, 0, 0, "stretch", 0, 0, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain10-flow020", 10, 0, 0, "stretch", 0.20, 80, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain12-flow030", 12, 0, 0, "stretch", 0.30, 120, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-flow030", 16, 0, 0, "stretch", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-flow045", 16, 0, 0, "stretch", 0.45, 170, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain20-flow045", 20, 0, 0, "stretch", 0.45, 190, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain12-flow030", 12, 0, 0, "capacity", 0.30, 120, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain16-flow045", 16, 0, 0, "capacity", 0.45, 170, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-boost04-flow030", 16, 4, 0, "stretch", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-work1-flow030", 16, 0, 1, "stretch", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-suction1-flow030", 16, 0, -1, "stretch", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-stretch-gain16-suction2-flow030", 16, 0, -2, "stretch", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain16-suction1-flow030", 16, 0, -1, "capacity", 0.30, 140, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain24-flow060", 24, 0, 0, "capacity", 0.60, 230, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain32-flow060", 32, 0, 0, "capacity", 0.60, 260, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain24-suction1-flow060", 24, 0, -1, "capacity", 0.60, 230, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
  variant("venous-capacity-gain32-suction2-flow060", 32, 0, -2, "capacity", 0.60, 260, 1.0, 30, 1.0, 18, 60, 0.06, 0.58, 0.055, 0.30, 0.085, 0.20),
];

export function runAVPlaneVenousReservoirCoEvolutionBenchV1():
AVPlaneVenousReservoirCoEvolutionReportV1 {
  const rawParamsByProfile = buildLeftHeartDynamicReserveVariantEnvelopeV1(LEFT_VARIANT_ID);
  const baselineVariant = AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_VARIANTS_V1[0]!;
  ...
  const rows = PROFILE_IDS.flatMap((profileId, index) => {
    ...
    return AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_VARIANTS_V1.map((variant) => {
      const params = variant.variantId === "compliance-node-no-avplane"
        ? baselineParams
        : applyAVPlaneVenousReservoirCoEvolutionVariantV1(rawParamsByProfile[index]!, variant);
  ...
  const variantSummaries = AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_VARIANTS_V1.map((variant) =>
  ...
  const status = bestVariant.contractPass === PROFILE_IDS.length && bestVariant.dtHalfContractPass === PROFILE_IDS.length
    ...
    : lobeBest.laPvLobeQualityPass > 2
      ...
      : "av-plane-venous-reservoir-coevolution-blocked";
  return {
    reportId: AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_REPORT_ID_V1,
    gateId: "avPlaneVenousReservoirCoEvolutionV1",
    mode: "left-heart-av-plane-venous-reservoir-coevolution-no-runtime",
    variants: AV_PLANE_VENOUS_RESERVOIR_COEVOLUTION_VARIANTS_V1,
    rows,
    variantSummaries,
    bestVariant,
    summary: {
    ...
    decision: {
      avPlaneVenousReservoirCoEvolutionStatus: status,
      nextAction: status === "av-plane-venous-reservoir-coevolution-signal"
        ...
        : status === "av-plane-venous-reservoir-coevolution-mixed"
          ? "Use this explicit venous-reservoir result to decide whether moving-boundary pulmonary venous filling can own the missing v-loop; do not tune pressure substitution or simple lobe generators."
          : "Keep atrial promotion blocked; explicit venous-reservoir co-evolution did not recover source-preserving opposed lobe quality.",
      blockedClaims: [
        "runtime-wiring",
...
export function applyAVPlaneVenousReservoirCoEvolutionVariantV1(
  params: LeftHeartSubsystemParamsV2,
  variant: AVPlaneVenousReservoirCoEvolutionVariantV1,
  ...
  return {
    ...base,
    laLobeGeneratorMode: "av-plane-venous-reservoir-transaction-v1",
...
): AVPlaneVenousReservoirCoEvolutionVariantV1 {
  return {
    variantId,
