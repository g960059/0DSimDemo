...
export const LEFT_HEART_OUTFLOW_REPAIR_REPORT_ID_V1 =
  "left-heart-outflow-repair-report-v1" as const;

type LeftHeartOutflowVariantIdV1 =
  | "v2-fixed2-soft-baseline"
  | "semilunar-loss2"
  | "semilunar-loss4"
  | "semilunar-loss2-root-runoff70"
  | "semilunar-loss4-root-runoff70";
...
export type LeftHeartOutflowPointResultV1 = {
...
export type LeftHeartOutflowVariantResultV1 = {
  readonly variantId: LeftHeartOutflowVariantIdV1;
  ...
  readonly pointResults: readonly LeftHeartOutflowPointResultV1[];
  readonly summary: {
...
export type LeftHeartOutflowRepairReportV1 = {
  readonly reportId: typeof LEFT_HEART_OUTFLOW_REPAIR_REPORT_ID_V1;
  readonly gateId: "leftHeartOutflowRepairGateV1";
  readonly sourceSurface: "v2-fixed2-soft";
  readonly variantResults: readonly LeftHeartOutflowVariantResultV1[];
  readonly decision: {
    readonly leftHeartGateBStatus: "mixed-repair-signal";
    readonly bestVariantId: LeftHeartOutflowVariantIdV1;
    readonly bestPassCount: number;
    readonly baselinePassCount: number;
    readonly repeatabilitySignal: "improved" | "unchanged-or-worse";
...
const VARIANTS: readonly VariantSpecV1[] = [
  {
    ...
    description: "Current V2 fixed-point soft-pressure surface from the residual attribution report.",
  ...
  {
    variantId: "semilunar-loss2",
    description: "Doubles AoV pressure-flow loss/inertance to test whether semilunar impedance removes high-drive root-flow decoupling.",
  ...
  {
    variantId: "semilunar-loss4",
    description: "Raises AoV linear loss more strongly while keeping inertance/quadratic loss at the loss2 level.",
    aovResistanceMultiplier: 4,
    aovInertanceMultiplier: 2,
    aovBernoulliMultiplier: 2,
    rootOutResistanceMultiplier: 1,
  },
  {
    ...
    description: "Combines semilunar loss2 with faster root runoff to test root-pressure retention versus output reserve.",
    aovResistanceMultiplier: 2,
    aovInertanceMultiplier: 2,
    aovBernoulliMultiplier: 2,
  ...
  {
    variantId: "semilunar-loss4-root-runoff70",
    description: "Combines stronger semilunar loss with faster root runoff.",
    aovResistanceMultiplier: 4,
    aovInertanceMultiplier: 2,
    aovBernoulliMultiplier: 2,
    rootOutResistanceMultiplier: 0.7,
...
export function runLeftHeartOutflowRepairBenchV1(): LeftHeartOutflowRepairReportV1 {
  ...
  const best = [...variantResults].sort((a, b) =>
    ...
    || b.summary.repeatabilityOkCount - a.summary.repeatabilityOkCount
    || b.summary.outputOkCount - a.summary.outputOkCount,
  )[0]!;
  const baselineMaxAlternans = baseline.summary.maxAovEjectionDeltaMl ?? Number.POSITIVE_INFINITY;
  const bestMaxAlternans = best.summary.maxAovEjectionDeltaMl ?? Number.POSITIVE_INFINITY;
  return {
    reportId: LEFT_HEART_OUTFLOW_REPAIR_REPORT_ID_V1,
    gateId: "leftHeartOutflowRepairGateV1",
    sourceSurface: "v2-fixed2-soft",
    variantResults,
    decision: {
      leftHeartGateBStatus: "mixed-repair-signal",
      bestVariantId: best.variantId,
      bestPassCount: best.summary.pass,
      baselinePassCount: baseline.summary.pass,
      repeatabilitySignal: bestMaxAlternans < baselineMaxAlternans ? "improved" : "unchanged-or-worse",
      nextAction: "Keep left-heart Gate B focused on semilunar/root outflow ownership: the best repair surface must improve pass count without beat-to-beat alternans, clamp hits, or MVF kinks before right-heart, four-chamber, or LandAtrial work resumes.",
    },
    claimBoundary: {
      runtimeWiring: false,
...
function runVariant(spec: VariantSpecV1): LeftHeartOutflowVariantResultV1 {
...
function runPoint(params: LeftHeartSubsystemParamsV2): LeftHeartOutflowPointResultV1 {
...
function classify(
  ...
  dtStable: boolean,
): LeftHeartOutflowPointResultV1["classifications"] {
...
function failureReasonsFor(
  classifications: LeftHeartOutflowPointResultV1["classifications"],
  beat: BeatSummaryV1,
  aovEjectionDeltaMl: number,
  strokeVolumeDeltaMl: number,
): readonly string[] {
