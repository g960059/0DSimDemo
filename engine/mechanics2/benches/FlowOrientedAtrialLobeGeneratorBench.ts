...
export const FLOW_ORIENTED_ATRIAL_LOBE_GENERATOR_REPORT_ID_V1 =
  "flow-oriented-atrial-lobe-generator-report-v1" as const;

type VariantIdV1 =
  | "fiber-pressure-no-lobe-state"
  | "phase-reference-r12-b0-p1"
  | "flow-rate50-r12-b0-p1"
  | "flow-rate70-r12-b0-p1"
  | "flow-rate90-r12-b0-p1"
  | "flow-wide-rate70-r12-b0-p1"
  | "flow-rate70-r16-b0-p1"
  | "flow-rate70-r12-b4-p1";
...
type VariantV1 = {
  ...
  readonly reservoirDriveMode: "phase" | "flow";
...
export type FlowOrientedAtrialLobeGeneratorReportV1 = {
  readonly reportId: typeof FLOW_ORIENTED_ATRIAL_LOBE_GENERATOR_REPORT_ID_V1;
  readonly gateId: "flowOrientedAtrialLobeGeneratorV1";
  readonly mode: "left-heart-flow-oriented-atrial-lobe-state-no-runtime";
  ...
  readonly decision: {
    readonly flowOrientedAtrialLobeGeneratorStatus:
      | "flow-oriented-atrial-lobe-generator-signal"
      | "flow-oriented-atrial-lobe-generator-mixed"
      | "flow-oriented-atrial-lobe-generator-blocked";
...
const VARIANTS: readonly VariantV1[] = [
  ...
  { variantId: "flow-rate50-r12-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 0, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 50, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "flow-rate70-r12-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 0, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 70, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "flow-rate90-r12-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 0, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 90, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "flow-wide-rate70-r12-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 0, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 70, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.02, reservoirEndTheta: 0.78 },
  { variantId: "flow-rate70-r16-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 16, boosterGeometryGainMl: 0, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 70, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "flow-rate70-r12-b4-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 4, reservoirDriveMode: "flow", reservoirFillingRateStartMlPerSec: 6, reservoirFillingRateEndMlPerSec: 70, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
];

export function runFlowOrientedAtrialLobeGeneratorBenchV1():
FlowOrientedAtrialLobeGeneratorReportV1 {
  ...
  const status = bestVariant.contractPass === PROFILE_IDS.length
    ...
    : lobeBest.laPvLobeQualityPass > 2 || sourceSurfaceBest.sourceSurfacePass >= 5
      ...
      : "flow-oriented-atrial-lobe-generator-blocked";
  return {
    reportId: FLOW_ORIENTED_ATRIAL_LOBE_GENERATOR_REPORT_ID_V1,
    gateId: "flowOrientedAtrialLobeGeneratorV1",
    mode: "left-heart-flow-oriented-atrial-lobe-state-no-runtime",
    variants: VARIANTS,
    rows,
    variantSummaries,
    bestVariant,
    ...
    decision: {
      flowOrientedAtrialLobeGeneratorStatus: status,
      nextAction: status === "flow-oriented-atrial-lobe-generator-signal"
        ? "Proceed only to source-aware four-chamber review. Runtime and physiology claims remain blocked."
        : status === "flow-oriented-atrial-lobe-generator-mixed"
          ? "Use this negative flow-oriented lobe signal to test stateful AV-plane descent as the reservoir-filling driver; keep runtime AV-plane and physiology claims blocked."
          : "Keep atrial promotion blocked; flow-oriented reservoir drive did not recover enough lobe quality or source-surface morphology.",
      blockedClaims: [
        "runtime-wiring",
