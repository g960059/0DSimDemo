...
export const DUAL_LOBE_CHAMBER_VALVE_GENERATOR_REPORT_ID_V1 =
  "dual-lobe-chamber-valve-generator-report-v1" as const;
...
type VariantIdV1 =
  ...
  | "geometry-r10-b4"
  | "geometry-r12-b6"
  | "geometry-wide-r10-b4"
  | "geometry-delayed-booster-r10-b6"
  | "geometry-pressure-hybrid-r8-b4-p1"
  | "geometry-pressure-hybrid-r8-b4-p2"
  | "geometry-pressure-hybrid-r12-b0-p1"
  | "geometry-pressure-hybrid-r8-b8-p1"
  | "geometry-pressure-hybrid-r16-b0-p1"
  | "geometry-pressure-hybrid-r16-b0-p2";
...
export type DualLobeChamberValveGeneratorReportV1 = {
  readonly reportId: typeof DUAL_LOBE_CHAMBER_VALVE_GENERATOR_REPORT_ID_V1;
  readonly gateId: "dualLobeChamberValveGeneratorV1";
  readonly mode: "left-heart-dual-lobe-chamber-valve-state-no-runtime";
  ...
  readonly decision: {
    readonly dualLobeChamberValveGeneratorStatus:
      | "dual-lobe-chamber-valve-generator-signal"
      | "dual-lobe-chamber-valve-generator-mixed"
      | "dual-lobe-chamber-valve-generator-blocked";
...
const VARIANTS: readonly VariantV1[] = [
  { variantId: "fiber-pressure-no-lobe-state", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 0, boosterGeometryGainMl: 0, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-r6-b0", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 6, boosterGeometryGainMl: 0, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-r8-b2", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 8, boosterGeometryGainMl: 2, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-r10-b4", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 10, boosterGeometryGainMl: 4, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-r12-b6", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 6, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-wide-r10-b4", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 10, boosterGeometryGainMl: 4, boosterStartTheta: 0.72, boosterEndTheta: 0.995, reservoirStartTheta: 0.02, reservoirEndTheta: 0.78 },
  { variantId: "geometry-delayed-booster-r10-b6", reservoirPressureGainMmHg: 0, boosterPressureGainMmHg: 0, reservoirGeometryGainMl: 10, boosterGeometryGainMl: 6, boosterStartTheta: 0.84, boosterEndTheta: 0.995, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r8-b4-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 8, boosterGeometryGainMl: 4, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r8-b4-p2", reservoirPressureGainMmHg: 2, boosterPressureGainMmHg: 2, reservoirGeometryGainMl: 8, boosterGeometryGainMl: 4, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r12-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 12, boosterGeometryGainMl: 0, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r8-b8-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 8, boosterGeometryGainMl: 8, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r16-b0-p1", reservoirPressureGainMmHg: 1, boosterPressureGainMmHg: 1, reservoirGeometryGainMl: 16, boosterGeometryGainMl: 0, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
  { variantId: "geometry-pressure-hybrid-r16-b0-p2", reservoirPressureGainMmHg: 2, boosterPressureGainMmHg: 2, reservoirGeometryGainMl: 16, boosterGeometryGainMl: 0, boosterStartTheta: 0.76, boosterEndTheta: 0.98, reservoirStartTheta: 0.08, reservoirEndTheta: 0.70 },
];

export function runDualLobeChamberValveGeneratorBenchV1():
DualLobeChamberValveGeneratorReportV1 {
  ...
  const status = bestVariant.contractPass === PROFILE_IDS.length
    ...
    : lobeBest.laPvLobeQualityPass > 2 || sourceSurfaceBest.sourceSurfacePass >= 5
      ...
      : "dual-lobe-chamber-valve-generator-blocked";
  return {
    reportId: DUAL_LOBE_CHAMBER_VALVE_GENERATOR_REPORT_ID_V1,
    gateId: "dualLobeChamberValveGeneratorV1",
    mode: "left-heart-dual-lobe-chamber-valve-state-no-runtime",
    variants: VARIANTS,
    rows,
    variantSummaries,
    bestVariant,
    ...
    decision: {
      dualLobeChamberValveGeneratorStatus: status,
      nextAction: status === "dual-lobe-chamber-valve-generator-signal"
        ? "Proceed only to source-aware four-chamber review. Runtime and physiology claims remain blocked."
        : status === "dual-lobe-chamber-valve-generator-mixed"
          ? "Use this dual-lobe chamber/valve signal to design the next atrial chamber/valve transaction; keep runtime and physiology claims blocked."
          : "Keep atrial promotion blocked; dual reservoir/booster geometry states did not recover enough lobe quality or source-surface morphology.",
      blockedClaims: [
        "runtime-wiring",
