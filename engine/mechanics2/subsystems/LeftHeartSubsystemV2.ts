...
export type LeftAtrialEffectiveGeometryModeV2 =
  ...
  | "av-plane-full-left-v16-transfer-hysteresis-v6";
...
export type LeftHeartSubsystemParamsV2 = LeftHeartSubsystemParamsV1 & {
  ...
  readonly laReservoirConduitWallViscoelasticGainMmHg: number;
  readonly laReservoirConduitWallViscoelasticFlowScaleMlPerSec: number;
  ...
  readonly laReservoirConduitPathReliefGainMmHg: number;
...
export function defaultLeftHeartSubsystemParamsV2(
  ...
  return {
    ...
    laReservoirConduitWallViscoelasticGainMmHg:
      overrides.laReservoirConduitWallViscoelasticGainMmHg ?? 0,
    laReservoirConduitWallViscoelasticFlowScaleMlPerSec:
      overrides.laReservoirConduitWallViscoelasticFlowScaleMlPerSec ?? 70,
    laReservoirConduitWallViscoelasticBoosterSuppression01:
      overrides.laReservoirConduitWallViscoelasticBoosterSuppression01 ?? 0.85,
    ...
    laReservoirConduitPathMemoryRiseTauSec:
      overrides.laReservoirConduitPathMemoryRiseTauSec ?? 0.055,
    laReservoirConduitPathMemoryFallTauSec:
      overrides.laReservoirConduitPathMemoryFallTauSec ?? 0.34,
    laReservoirConduitPathReliefGainMmHg:
      overrides.laReservoirConduitPathReliefGainMmHg ?? 0,
    laReservoirConduitPathReliefFlowScaleMlPerSec:
      overrides.laReservoirConduitPathReliefFlowScaleMlPerSec ?? 95,
    ...
    lvEarlyFillingReceiverCapacityGain01:
      overrides.lvEarlyFillingReceiverCapacityGain01 ?? 0,
    lvEarlyFillingReceiverCapacityRiseTauSec:
    ...
    laMvLvReceiverPathRiseTauSec:
      overrides.laMvLvReceiverPathRiseTauSec ?? 0.038,
    laMvLvReceiverPathFallTauSec:
      overrides.laMvLvReceiverPathFallTauSec ?? 0.18,
    ...
    const result = runMechanicsFixedPointTransactionV2(
      ...
      (candidate, accepted) => rootMeanSquareResidualV2([
        ...
        isFullLeftImplicitMvStateMode(params)
          ? (accepted.mvImplicitTarget.open01 - candidate.mvOpenEstimate01)
            ...
            * Math.max(0, params.laAVPlaneImplicitMvStateGain)
          : 0,
        isFullLeftReservoirConduitHysteresisV4Mode(params)
        ...
        isFullLeftReservoirConduitPressureMemoryV5Mode(params)
          ? (accepted.laAVPlaneReservoirConduitPressureMemoryMmHg
            ...
            * 0.35
          : 0,
        usesLaReservoirConduitWallViscoelasticPressure(params)
          ? (accepted.laReservoirConduitWallViscoelasticPressureMmHg
            - candidate.laReservoirConduitWallViscoelasticPressureMmHg)
            * inputCoordinateResidualScaleMl(params)
            * 0.28
          : 0,
        usesLaReservoirConduitPathState(params)
          ? (accepted.laReservoirConduitPathMemory01 - candidate.laReservoirConduitPathMemory01)
            * inputCoordinateResidualScaleMl(params)
            * 0.28
          : 0,
        usesLaReservoirConduitPathRelief(params)
        ...
        usesLaMvLvReceiverPathState(params)
          ? (accepted.laMvLvReceiverPath01 - candidate.laMvLvReceiverPath01)
            ...
            * 0.35
          : 0,
        usesLvEarlyFillingReceiverCapacityState(params)
          ? (accepted.lvEarlyFillingReceiverCapacity01 - candidate.lvEarlyFillingReceiverCapacity01)
            * inputCoordinateResidualScaleMl(params)
            * 0.35
          : 0,
      ...
      (candidate, accepted, relaxation) => ({
        ...
        laAVPlaneWorkCoordinateZDotNormPerSec: isFullLeftResidualCoordinateMode(params)
          ...
          : accepted.laAVPlaneWorkCoordinateZDotNormPerSec,
        laAVPlaneReservoirConduitHysteresis01: isFullLeftReservoirConduitHysteresisV4Mode(params)
          ? lerpV2(
            candidate.laAVPlaneReservoirConduitHysteresis01,
        ...
        laAVPlaneReservoirConduitPressureMemoryMmHg: isFullLeftReservoirConduitPressureMemoryV5Mode(params)
          ...
          : accepted.laAVPlaneReservoirConduitPressureMemoryMmHg,
        laReservoirConduitWallViscoelasticPressureMmHg: usesLaReservoirConduitWallViscoelasticPressure(params)
          ? lerpV2(
            candidate.laReservoirConduitWallViscoelasticPressureMmHg,
            accepted.laReservoirConduitWallViscoelasticPressureMmHg,
            relaxation,
          ...
          : accepted.laReservoirConduitWallViscoelasticPressureMmHg,
        laReservoirConduitPathMemory01: usesLaReservoirConduitPathState(params)
          ? lerpV2(
            candidate.laReservoirConduitPathMemory01,
            accepted.laReservoirConduitPathMemory01,
            relaxation,
          )
          : accepted.laReservoirConduitPathMemory01,
        laReservoirConduitPathReliefMmHg: usesLaReservoirConduitPathRelief(params)
          ? lerpV2(
            candidate.laReservoirConduitPathReliefMmHg,
        ...
        lvEarlyFillingReceiverCapacity01: usesLvEarlyFillingReceiverCapacityState(params)
          ? lerpV2(candidate.lvEarlyFillingReceiverCapacity01, accepted.lvEarlyFillingReceiverCapacity01, relaxation)
          : accepted.lvEarlyFillingReceiverCapacity01,
...
function acceptLeftHeartCandidateV2(input: {
  ...
  const laReservoirConduitWallViscoelasticPressureTargetMmHg =
    leftAtrialReservoirConduitWallViscoelasticPressureTargetMmHg(
      input.params,
      input.theta,
      input.candidate.laVolumeMl - input.previous.laVolumeMl,
      input.dtSec,
    );
  const laReservoirConduitWallViscoelasticPressureMmHg =
  ...
  let laReservoirGeometryDeltaMl =
    ...
    || input.params.laEffectiveGeometryMode === "av-plane-full-left-reservoir-conduit-hysteresis-v1"
    ...
    || input.params.laEffectiveGeometryMode === "av-plane-full-left-v16-transfer-hysteresis-v6"
    ? avPlaneGeometryReadback.atrialGeometryDeltaMl
    : 0;
  ...
  const laReservoirConduitPathReliefMmHg =
    usesLaReservoirConduitPathRelief(input.params)
  ...
  if (
    ...
    || input.params.laLobeGeneratorMode === "av-plane-full-left-v16-transfer-hysteresis-v6"
  ) {
  ...
  const laAVPlaneReservoirConduitHysteresisTarget01 = fullLeftReservoirConduitHysteresisTarget01For({
    params: input.params,
  ...
  const laMvLvReceiverPathTarget01 = laMvLvReceiverPathTarget01For({
    params: input.params,
    theta: input.theta,
    previous: input.previous,
    path01: laAVPlaneReservoirConduitHysteresis01,
  ...
  const laMvLvReceiverPath01 = nextLaMvLvReceiverPath01(
    input.previous.laMvLvReceiverPath01,
    laMvLvReceiverPathTarget01,
    input.dtSec,
    input.params,
  );
  const lvEarlyFillingReceiverCapacityTarget01 =
    lvEarlyFillingReceiverCapacityTarget01For({
      params: input.params,
      theta: input.theta,
      previous: input.previous,
      path01: laAVPlaneReservoirConduitHysteresis01,
      receiverPath01: laMvLvReceiverPath01,
      mvOpen01: mv.open01,
      mvQMlPerSec: mv.qMlPerSec,
      lapMmHg,
      lvpMmHg,
    });
  const lvEarlyFillingReceiverCapacity01 = nextLvEarlyFillingReceiverCapacity01(
    input.previous.lvEarlyFillingReceiverCapacity01,
    lvEarlyFillingReceiverCapacityTarget01,
    input.dtSec,
    input.params,
  );
  const lvEarlyFillingReceiverReliefTargetMmHg =
    lvEarlyFillingReceiverReliefTargetMmHgFor({
      ...
      path01: laAVPlaneReservoirConduitHysteresis01,
      receiverPath01: laMvLvReceiverPath01,
      receiverCapacity01: lvEarlyFillingReceiverCapacity01,
      mvOpen01: mv.open01,
      mvQMlPerSec: mv.qMlPerSec,
      lapMmHg,
      lvpMmHg,
  ...
  const acceptedLaReservoirConduitWallViscoelasticPressureMmHg =
    nextLaReservoirConduitWallViscoelasticPressureMmHg(
      input.previous.laReservoirConduitWallViscoelasticPressureMmHg,
      laReservoirConduitWallViscoelasticPressureTargetMmHg,
      input.dtSec,
      input.params,
    );
  const laReservoirConduitPathMemoryTarget01 = leftAtrialReservoirConduitPathMemoryTarget01For({
    params: input.params,
    theta: input.theta,
    previous: input.previous,
    mvOpen01: mv.open01,
  ...
  const laReservoirConduitPathMemory01 = nextLaReservoirConduitPathMemory01(
    input.previous.laReservoirConduitPathMemory01,
    laReservoirConduitPathMemoryTarget01,
    input.dtSec,
    input.params,
  );
  const laReservoirConduitPathReliefTargetMmHg =
    leftAtrialReservoirConduitPathReliefTargetMmHgFor({
      params: input.params,
      theta: input.theta,
      previous: input.previous,
      ...
      receiverPath01: laMvLvReceiverPath01,
      receiverCapacity01: lvEarlyFillingReceiverCapacity01,
      receiverReliefMmHg: lvEarlyFillingReceiverReliefMmHg,
      mvOpen01: mv.open01,
      mvQMlPerSec: mv.qMlPerSec,
      lapMmHg,
      lvpMmHg,
    });
  const acceptedLaReservoirConduitPathReliefMmHg = nextLaReservoirConduitPathReliefMmHg(
    input.previous.laReservoirConduitPathReliefMmHg,
    laReservoirConduitPathReliefTargetMmHg,
    input.dtSec,
    input.params,
  );
...
function isFullLeftReferenceCapacityResidualMode(params: LeftHeartSubsystemParamsV2): boolean {
  return params.laLobeGeneratorMode === "av-plane-full-left-reference-capacity-residual-v1"
    ...
    || params.laEffectiveGeometryMode === "av-plane-full-left-v16-transfer-hysteresis-v6";
}
...
function isFullLeftReservoirConduitHysteresisMode(params: LeftHeartSubsystemParamsV2): boolean {
  return params.laLobeGeneratorMode === "av-plane-full-left-reservoir-conduit-hysteresis-v1"
    || params.laLobeGeneratorMode === "av-plane-full-left-reservoir-conduit-hysteresis-v2"
    || params.laLobeGeneratorMode === "av-plane-full-left-reservoir-conduit-hysteresis-v3"
    || params.laEffectiveGeometryMode === "av-plane-full-left-reservoir-conduit-hysteresis-v1"
    || params.laEffectiveGeometryMode === "av-plane-full-left-reservoir-conduit-hysteresis-v2"
...
function isFullLeftReservoirConduitHysteresisV2Mode(params: LeftHeartSubsystemParamsV2): boolean {
  return params.laLobeGeneratorMode === "av-plane-full-left-reservoir-conduit-hysteresis-v2"
    || params.laEffectiveGeometryMode === "av-plane-full-left-reservoir-conduit-hysteresis-v2";
}

function isFullLeftReservoirConduitHysteresisV3Mode(params: LeftHeartSubsystemParamsV2): boolean {
  return params.laLobeGeneratorMode === "av-plane-full-left-reservoir-conduit-hysteresis-v3"
    || params.laEffectiveGeometryMode === "av-plane-full-left-reservoir-conduit-hysteresis-v3";
}
...
function fullLeftResidualCoordinateResiduals(
  ...
  if (isFullLeftContinuousTrajectoryLawMode(params)) {
    const targetZNorm = isFullLeftReservoirConduitHysteresisV4Mode(params)
      ? fullLeftReservoirConduitHysteresisV4TargetZNorm(params, previous, candidate, accepted, theta)
      : isFullLeftReservoirConduitHysteresisV3Mode(params)
      ? fullLeftReservoirConduitHysteresisV3TargetZNorm(params, previous, accepted)
      : isFullLeftReservoirConduitHysteresisV2Mode(params)
      ? fullLeftReservoirConduitHysteresisV2TargetZNorm(params, previous, accepted)
      : isFullLeftReservoirConduitHysteresisMode(params)
        ? fullLeftReservoirConduitHysteresisTargetZNorm(params, previous, accepted)
      : fullLeftContinuousTrajectoryTargetZNorm(params, accepted);
    ...
    const phaseLockedGain01 = clamp(params.laAVPlanePhaseLockedTrajectoryGain01, 0, 1);
    const coordinateTargetWeight = phaseLockedGain01 > 0 ? 0.055 : 0.010;
    const coordinateVelocityWeight = phaseLockedGain01 > 0 ? 0.085 : 0.020;
    residuals.push(
      (candidate.laAVPlaneWorkCoordinateZNorm - projectedTargetZNorm) * scaleMl * coordinateTargetWeight,
      (candidate.laAVPlaneWorkCoordinateZDotNormPerSec - targetZDotNormPerSec)
        * scaleMl
        * Math.max(dtSec, 1e-9)
        * coordinateVelocityWeight,
    ...
    if (
      ...
      const pressureReliefDeltaMl = pressureReliefMl - previousPressureReliefMl;
      const reservoirCapacityFlowMlPerSec = Math.max(0, pressureReliefDeltaMl / Math.max(dtSec, 1e-9));
      const conduitRecoilCapacityFlowMlPerSec = Math.max(0, -pressureReliefDeltaMl / Math.max(dtSec, 1e-9));
      const mvClosedGate01 = 1 - smoothstep01(
        accepted.mv.open01 / Math.max(params.laAVPlaneVenousReservoirMvOpenReleaseThreshold01, 1e-9),
      );
      const expectedKinematicReservoirFlowMlPerSec = clamp(
        params.laAVPlaneVenousReservoirCouplingGain
          * reservoirCapacityFlowMlPerSec
          * mvClosedGate01,
        0,
        params.laAVPlaneVenousReservoirMaxFlowMlPerSec,
      );
      residuals.push(
        (accepted.qAVPlaneReservoirKinematicMlPerSec - expectedKinematicReservoirFlowMlPerSec)
          * Math.max(dtSec, 1e-9)
          * 0.008,
        dtSec
          * (accepted.qPulmonaryVenousSourceMlPerSec - accepted.qPulmonaryVenousMlPerSec)
          * 0.004,
      );
      if (isFullLeftReservoirConduitHysteresisV3Mode(params)) {
        const mvOpenDrive01 = smoothstep01(
          accepted.mv.open01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
        );
        const mvForwardFlowDrive01 = smoothstep01(Math.max(0, accepted.mv.qMlPerSec) / 120);
        const previousMvForwardFlowDrive01 = smoothstep01(Math.max(0, previous.mvQEstimateMlPerSec) / 120);
        const earlyConduitDrive01 = mvOpenDrive01 * Math.max(0, 1 - mvForwardFlowDrive01);
        const expectedConduitRecoilCapacityFlowMlPerSec = clamp(
          params.laAVPlaneVenousReservoirCouplingGain
            * conduitRecoilCapacityFlowMlPerSec
            * mvOpenDrive01
            * (0.45 + 0.55 * previousMvForwardFlowDrive01),
          0,
          params.laAVPlaneVenousReservoirMaxFlowMlPerSec,
        );
        residuals.push(
          expectedConduitRecoilCapacityFlowMlPerSec * Math.max(dtSec, 1e-9) * earlyConduitDrive01 * 0.003,
          accepted.mv.pressureFlowResidualMmHg * mvOpenDrive01 * 0.006,
        );
      }
      if (isFullLeftReservoirConduitHysteresisV4Mode(params)) {
        const targetHysteresis01 = fullLeftReservoirConduitHysteresisTarget01(params, previous, accepted);
        const conduitPath01 = clamp(candidate.laAVPlaneReservoirConduitHysteresis01, 0, 1);
        const mvOpenDrive01 = smoothstep01(
          accepted.mv.open01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
        );
        const mvForwardFlowMlPerSec = Math.max(0, accepted.mv.qMlPerSec);
        const pulmonarySourceFlowMlPerSec = Math.max(0, accepted.qPulmonaryVenousSourceMlPerSec);
        const physiologicRecoilCapacityFlowMlPerSec =
          mvOpenDrive01
          * conduitPath01
          * (0.30 * mvForwardFlowMlPerSec + 0.18 * pulmonarySourceFlowMlPerSec + 12);
        const excessRecoilCapacityFlowMlPerSec =
          Math.max(0, conduitRecoilCapacityFlowMlPerSec - physiologicRecoilCapacityFlowMlPerSec);
        residuals.push(
          (candidate.laAVPlaneReservoirConduitHysteresis01 - targetHysteresis01) * scaleMl * 0.018,
          excessRecoilCapacityFlowMlPerSec * Math.max(dtSec, 1e-9) * 0.004,
...
function fullLeftReservoirConduitHysteresisTargetZNorm(
  params: LeftHeartSubsystemParamsV2,
  previous: CandidateV2,
  accepted: AcceptedV2,
): number {
  ...
  const mvForwardFlowDrive01 = smoothstep01(Math.max(0, accepted.mv.qMlPerSec) / 90);
  const mvForwardDecelDrive01 = smoothstep01(
    (Math.max(0, previous.mvQEstimateMlPerSec) - Math.max(0, accepted.mv.qMlPerSec)) / 70,
  );
  const pulmonarySourceDrive01 = smoothstep01(Math.max(0, accepted.qPulmonaryVenousSourceMlPerSec) / 80);
  const pressureGradientMmHg =
    (accepted.lapRawMmHg + accepted.lapSafetyMmHg) - (accepted.lvpRawMmHg + accepted.lvpSafetyMmHg);
  const laToLvReliefDrive01 = smoothstep01(pressureGradientMmHg / 4);
  const reservoirTarget = clamp(
    ejectionDrive01
      * (1 + 0.12 * pulmonarySourceDrive01)
      * (1 - 0.10 * laToLvReliefDrive01),
    0,
    1,
  );
  const conduitDrive01 = clamp(
    mvOpenDrive01
      * (0.18 + 0.82 * mvForwardDecelDrive01)
      * (1 - 0.28 * mvForwardFlowDrive01),
    0,
    1,
  );
  const conduitFloor = clamp(0.08 + 0.16 * pulmonarySourceDrive01 - 0.04 * laToLvReliefDrive01, 0.04, 0.28);
  const previousZ = clamp(previous.laAVPlaneWorkCoordinateZNorm, 0, 1);
  const recoilTarget = clamp(
    previousZ * (1 - 0.30 * conduitDrive01) + conduitFloor * conduitDrive01,
    0,
    1,
  );
  return conduitDrive01 > 0.02 ? recoilTarget : reservoirTarget;
}

function fullLeftReservoirConduitHysteresisV2TargetZNorm(
  params: LeftHeartSubsystemParamsV2,
  previous: CandidateV2,
  accepted: AcceptedV2,
): number {
  ...
  const mvForwardFlowMlPerSec = Math.max(0, accepted.mv.qMlPerSec);
  const previousMvForwardFlowMlPerSec = Math.max(0, previous.mvQEstimateMlPerSec);
  const mvForwardFlowDrive01 = smoothstep01(mvForwardFlowMlPerSec / 110);
  const mvForwardDecelDrive01 = smoothstep01(
    (previousMvForwardFlowMlPerSec - mvForwardFlowMlPerSec) / 85,
  );
  const pulmonarySourceDrive01 = smoothstep01(Math.max(0, accepted.qPulmonaryVenousSourceMlPerSec) / 90);
  const pressureGradientMmHg =
    (accepted.lapRawMmHg + accepted.lapSafetyMmHg) - (accepted.lvpRawMmHg + accepted.lvpSafetyMmHg);
  const laToLvReliefDrive01 = smoothstep01(pressureGradientMmHg / 4);
  const previousZ = clamp(previous.laAVPlaneWorkCoordinateZNorm, 0, 1);
  const reservoirTarget = clamp(
    ejectionDrive01
      * (1 + 0.16 * pulmonarySourceDrive01)
      * (1 - 0.08 * laToLvReliefDrive01),
    0,
    1,
  );
  const earlyConduitRetention01 = clamp(
    0.88
      - 0.28 * mvForwardDecelDrive01
      - 0.16 * mvForwardFlowDrive01
      + 0.08 * pulmonarySourceDrive01,
    0.44,
    0.90,
  );
  const conduitFloor = clamp(
    0.12 + 0.12 * pulmonarySourceDrive01 - 0.04 * laToLvReliefDrive01,
    0.08,
    0.30,
  );
  const conduitTarget = clamp(
    previousZ * earlyConduitRetention01 + conduitFloor * (1 - earlyConduitRetention01),
    0,
    1,
  );
  return mvOpenDrive01 > 0.02 ? conduitTarget : reservoirTarget;
}

function fullLeftReservoirConduitHysteresisV3TargetZNorm(
  params: LeftHeartSubsystemParamsV2,
  previous: CandidateV2,
  accepted: AcceptedV2,
): number {
  ...
  const mvForwardFlowMlPerSec = Math.max(0, accepted.mv.qMlPerSec);
  const previousMvForwardFlowMlPerSec = Math.max(0, previous.mvQEstimateMlPerSec);
  const mvForwardFlowDrive01 = smoothstep01(mvForwardFlowMlPerSec / 120);
  const mvForwardDecelDrive01 = smoothstep01(
    (previousMvForwardFlowMlPerSec - mvForwardFlowMlPerSec) / 70,
  );
  const pulmonarySourceDrive01 = smoothstep01(Math.max(0, accepted.qPulmonaryVenousSourceMlPerSec) / 90);
  const pressureGradientMmHg =
    (accepted.lapRawMmHg + accepted.lapSafetyMmHg) - (accepted.lvpRawMmHg + accepted.lvpSafetyMmHg);
  const laToLvReliefDrive01 = smoothstep01(pressureGradientMmHg / 3.2);
  const previousZ = clamp(previous.laAVPlaneWorkCoordinateZNorm, 0, 1);
  const reservoirTarget = clamp(
    ejectionDrive01
      * (1 + 0.18 * pulmonarySourceDrive01)
      * (1 - 0.10 * laToLvReliefDrive01),
    0,
    1,
  );
  const openingHold01 = clamp(
    0.72
      + 0.16 * pulmonarySourceDrive01
      - 0.18 * mvForwardFlowDrive01
      - 0.20 * mvForwardDecelDrive01,
    0.42,
    0.86,
  );
  const recoilDrive01 = clamp(
    mvOpenDrive01
      * (0.20 + 0.58 * mvForwardDecelDrive01 + 0.22 * mvForwardFlowDrive01)
      * (0.72 + 0.28 * laToLvReliefDrive01),
    0,
    1,
  );
  const conduitFloor = clamp(
    0.10 + 0.10 * pulmonarySourceDrive01 - 0.05 * laToLvReliefDrive01,
    0.05,
    0.26,
  );
  const heldOpeningTarget = clamp(
    previousZ * openingHold01 + reservoirTarget * (1 - openingHold01),
    0,
    1,
  );
  const conduitTarget = clamp(
    heldOpeningTarget * (1 - 0.46 * recoilDrive01) + conduitFloor * 0.46 * recoilDrive01,
    0,
    1,
  );
  return mvOpenDrive01 > 0.015 ? conduitTarget : reservoirTarget;
}

function fullLeftReservoirConduitHysteresisTarget01(
  params: LeftHeartSubsystemParamsV2,
  previous: CandidateV2,
  accepted: AcceptedV2,
): number {
  return fullLeftReservoirConduitHysteresisTarget01For({
    params,
    previous,
    mvOpen01: accepted.mv.open01,
    mvQMlPerSec: accepted.mv.qMlPerSec,
...
function fullLeftReservoirConduitHysteresisTarget01For(input: {
  readonly params: LeftHeartSubsystemParamsV2;
  readonly previous: CandidateV2;
  readonly mvOpen01: number;
  ...
  const { params, previous } = input;
  if (!isFullLeftReservoirConduitHysteresisV4Mode(params)) return 0;
  const mvOpenDrive01 = smoothstep01(
    input.mvOpen01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
  );
  const mvForwardFlowDrive01 = smoothstep01(Math.max(0, input.mvQMlPerSec) / 105);
  const previousMvForwardFlowDrive01 = smoothstep01(Math.max(0, previous.mvQEstimateMlPerSec) / 105);
  const mvForwardDecelDrive01 = smoothstep01(
    (Math.max(0, previous.mvQEstimateMlPerSec) - Math.max(0, input.mvQMlPerSec)) / 82,
  );
  const ejectionDrive01 = smoothstep01(
  ...
  return clamp(
    mvOpenDrive01
      * (1 - 0.74 * ejectionDrive01)
      * (0.28 + 0.42 * mvForwardFlowDrive01 + 0.18 * previousMvForwardFlowDrive01
        + 0.12 * mvForwardDecelDrive01)
      * (0.86 + 0.14 * pulmonarySourceDrive01),
    0,
    1,
  );
}

function nextFullLeftReservoirConduitHysteresis01(
  previousHysteresis01: number,
  targetHysteresis01: number,
  dtSec: number,
  params: LeftHeartSubsystemParamsV2,
): number {
  if (!isFullLeftReservoirConduitHysteresisV4Mode(params)) return 0;
  const tauSec = targetHysteresis01 > previousHysteresis01
    ? Math.max(0.09, params.laAVPlaneReservoirCapacityReleaseTauSec)
    : Math.max(0.12, params.laAVPlaneReservoirCapacityFallTauSec);
  const step = (targetHysteresis01 - previousHysteresis01) * dtSec / Math.max(tauSec, 1e-9);
...
function usesLaReservoirConduitWallViscoelasticPressure(params: LeftHeartSubsystemParamsV2): boolean {
  return Math.max(0, params.laReservoirConduitWallViscoelasticGainMmHg) > 0;
}

function usesLaReservoirConduitPathState(params: LeftHeartSubsystemParamsV2): boolean {
  return clamp(params.laReservoirConduitPathMemoryGain01, 0, 1) > 0;
}

function usesLaReservoirConduitPathRelief(params: LeftHeartSubsystemParamsV2): boolean {
...
function nextLaReservoirConduitWallViscoelasticPressureMmHg(
  ...
  if (!usesLaReservoirConduitWallViscoelasticPressure(params)) return 0;
  const tauSec = Math.abs(targetPressureMmHg) > Math.abs(previousPressureMmHg)
    ? Math.max(0.012, params.laReservoirConduitWallViscoelasticRiseTauSec)
    : Math.max(0.018, params.laReservoirConduitWallViscoelasticFallTauSec);
...
function leftAtrialReservoirConduitPathMemoryTarget01For(input: {
  ...
  const { params } = input;
  const gain01 = clamp(params.laReservoirConduitPathMemoryGain01, 0, 1);
  if (gain01 <= 0) return 0;
  ...
  const systolicWindow01 = raisedCosineWindow(input.theta, 0.045, 0.48);
  const pulmonarySourceDrive01 = smoothstep01(Math.max(0, input.qPulmonaryVenousSourceMlPerSec) / 90);
  const zDrive01 = smoothstep01(clamp(input.zNorm, 0, 1) / 0.68);
  const previousMemory01 = clamp(input.previous.laReservoirConduitPathMemory01, 0, 1);
  const target01 =
    mvClosedDrive01
    * systolicWindow01
    * (0.48 * ejectionDrive01 + 0.22 * zDrive01 + 0.18 * pulmonarySourceDrive01 + 0.12 * previousMemory01);
  return gain01 * clamp(target01, 0, 1);
}

function nextLaReservoirConduitPathMemory01(
  previousPathMemory01: number,
  targetPathMemory01: number,
  dtSec: number,
  params: LeftHeartSubsystemParamsV2,
): number {
  if (!usesLaReservoirConduitPathState(params)) return 0;
  const tauSec = targetPathMemory01 > previousPathMemory01
    ? Math.max(0.018, params.laReservoirConduitPathMemoryRiseTauSec)
    : Math.max(0.080, params.laReservoirConduitPathMemoryFallTauSec);
  const step = (targetPathMemory01 - previousPathMemory01) * dtSec / Math.max(tauSec, 1e-9);
  return clamp(previousPathMemory01 + step, 0, clamp(params.laReservoirConduitPathMemoryGain01, 0, 1));
}

function leftAtrialReservoirConduitPathReliefTargetMmHgFor(input: {
  readonly params: LeftHeartSubsystemParamsV2;
  readonly theta: number;
  readonly previous: CandidateV2;
  readonly pathMemory01: number;
  readonly receiverPath01: number;
  readonly receiverCapacity01: number;
  readonly receiverReliefMmHg: number;
  readonly mvOpen01: number;
  readonly mvQMlPerSec: number;
  readonly lapMmHg: number;
  readonly lvpMmHg: number;
  ...
  const { params } = input;
  const gainMmHg = Math.max(0, params.laReservoirConduitPathReliefGainMmHg);
  if (gainMmHg <= 0) return 0;
  const mvOpenDrive01 = smoothstep01(
    input.mvOpen01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
  );
  const earlyDiastolicWindow01 = raisedCosineWindow(
    input.theta,
  ...
  const receiverCapacity01 = clamp(input.receiverCapacity01, 0, 1);
  const receiverRelief01 = smoothstep01(
    input.receiverReliefMmHg / Math.max(0.5, params.lvEarlyFillingReceiverReliefGainMmHg),
  );
  const laToLvGradientDrive01 = smoothstep01((input.lapMmHg - input.lvpMmHg) / 3.0);
  const previousReliefMemory01 = smoothstep01(
  ...
  const receiverDrive01 = clamp(
    0.36
      + 0.22 * receiverPath01
      + 0.18 * receiverCapacity01
      + 0.12 * receiverRelief01
      + 0.08 * laToLvGradientDrive01
      + 0.08 * previousReliefMemory01,
    0,
    1,
  );
...
function nextLaReservoirConduitPathReliefMmHg(
  ...
  if (!usesLaReservoirConduitPathRelief(params)) return 0;
  const tauSec = targetReliefMmHg > previousReliefMmHg
    ? Math.max(0.018, params.laReservoirConduitPathReliefRiseTauSec)
...
function usesLaMvLvReceiverPathState(params: LeftHeartSubsystemParamsV2): boolean {
  return Math.max(0, params.laMvLvReceiverPathGain01) > 0;
}

function usesLvEarlyFillingReceiverCapacityState(params: LeftHeartSubsystemParamsV2): boolean {
...
function laMvLvReceiverPathTarget01For(input: {
  ...
  const { params } = input;
  const gain01 = clamp(params.laMvLvReceiverPathGain01, 0, 1);
  if (gain01 <= 0) return 0;
  const mvOpenDrive01 = smoothstep01(
    input.mvOpen01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
  );
  const mvForwardFlowDrive01 = smoothstep01(Math.max(0, input.mvQMlPerSec) / 58);
  const previousMvForwardDrive01 = smoothstep01(Math.max(0, input.previous.mvQEstimateMlPerSec) / 58);
  const mvForwardAccelerationDrive01 = smoothstep01(
    (Math.max(0, input.mvQMlPerSec) - Math.max(0, input.previous.mvQEstimateMlPerSec)) / 46,
  );
  ...
  const receiverPath01 =
    ...
    * (0.62 + 0.38 * pressureReceiverDrive01);
  return gain01 * clamp(receiverPath01, 0, 1);
}

function nextLaMvLvReceiverPath01(
  previousReceiverPath01: number,
  targetReceiverPath01: number,
  dtSec: number,
  params: LeftHeartSubsystemParamsV2,
): number {
  if (!usesLaMvLvReceiverPathState(params)) return 0;
  const tauSec = targetReceiverPath01 > previousReceiverPath01
    ? Math.max(0.018, params.laMvLvReceiverPathRiseTauSec)
    : Math.max(0.050, params.laMvLvReceiverPathFallTauSec);
  const step = (targetReceiverPath01 - previousReceiverPath01) * dtSec / Math.max(tauSec, 1e-9);
  return clamp(previousReceiverPath01 + step, 0, clamp(params.laMvLvReceiverPathGain01, 0, 1));
}
...
function lvEarlyFillingReceiverEffectiveMvDownstreamPressureMmHg(
  ...
  return Math.max(
    0,
    lvpMmHg - clamp(
      receiverReliefMmHg + capacityReliefMmHg,
      0,
      Math.max(0, params.lvEarlyFillingReceiverReliefGainMmHg) * 1.55,
    ),
  );
}

function lvEarlyFillingReceiverCapacityTarget01For(input: {
  readonly params: LeftHeartSubsystemParamsV2;
  readonly theta: number;
  readonly previous: CandidateV2;
  readonly path01: number;
  ...
  const { params } = input;
  const gain01 = clamp(params.lvEarlyFillingReceiverCapacityGain01, 0, 1);
  if (gain01 <= 0) return 0;
  const mvOpenDrive01 = smoothstep01(
    input.mvOpen01 / Math.max(params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
  );
  const mvForwardFlowDrive01 = smoothstep01(Math.max(0, input.mvQMlPerSec) / 78);
  const previousMvForwardDrive01 = smoothstep01(Math.max(0, input.previous.mvQEstimateMlPerSec) / 78);
  const mvForwardAccelerationDrive01 = smoothstep01(
    (Math.max(0, input.mvQMlPerSec) - Math.max(0, input.previous.mvQEstimateMlPerSec)) / 52,
  );
  const earlyDiastolicDrive01 = raisedCosineWindow(
    input.theta,
    params.lvEarlyFillingReceiverReliefStartTheta,
...
function nextLvEarlyFillingReceiverCapacity01(
  previousReceiverCapacity01: number,
  targetReceiverCapacity01: number,
  dtSec: number,
  params: LeftHeartSubsystemParamsV2,
): number {
  if (!usesLvEarlyFillingReceiverCapacityState(params)) return 0;
  const tauSec = targetReceiverCapacity01 > previousReceiverCapacity01
    ? Math.max(0.016, params.lvEarlyFillingReceiverCapacityRiseTauSec)
    : Math.max(0.060, params.lvEarlyFillingReceiverCapacityFallTauSec);
  const step = (targetReceiverCapacity01 - previousReceiverCapacity01) * dtSec / Math.max(tauSec, 1e-9);
  return clamp(previousReceiverCapacity01 + step, 0, clamp(params.lvEarlyFillingReceiverCapacityGain01, 0, 1));
}
...
function fullLeftReservoirConduitHysteresisV4TargetZNorm(
  ...
  const mvForwardFlowDrive01 = smoothstep01(Math.max(0, accepted.mv.qMlPerSec) / 120);
  const mvForwardDecelDrive01 = smoothstep01(
    (Math.max(0, previous.mvQEstimateMlPerSec) - Math.max(0, accepted.mv.qMlPerSec)) / 95,
  );
  const pulmonarySourceDrive01 = smoothstep01(Math.max(0, accepted.qPulmonaryVenousSourceMlPerSec) / 90);
  const pressureGradientMmHg =
    (accepted.lapRawMmHg + accepted.lapSafetyMmHg) - (accepted.lvpRawMmHg + accepted.lvpSafetyMmHg);
  const laToLvReliefDrive01 = smoothstep01(pressureGradientMmHg / 3.6);
  const path01 = clamp(candidate.laAVPlaneReservoirConduitHysteresis01, 0, 1);
  const receiverPath01 = usesLaMvLvReceiverPathState(params)
    ? clamp(candidate.laMvLvReceiverPath01, 0, 1)
    : 0;
  const receiverCapacity01 = usesLvEarlyFillingReceiverCapacityState(params)
    ? clamp(candidate.lvEarlyFillingReceiverCapacity01, 0, 1)
    : 0;
  const previousZ = clamp(previous.laAVPlaneWorkCoordinateZNorm, 0, 1);
  const reservoirTarget = clamp(
    ejectionDrive01
  ...
  const conduitRetention01 = clamp(
    0.90
      - 0.16 * mvForwardFlowDrive01
      - 0.12 * mvForwardDecelDrive01
      + 0.08 * pulmonarySourceDrive01
      - 0.04 * laToLvReliefDrive01
      + 0.22 * receiverPath01
      + 0.16 * receiverCapacity01,
    0.58,
    0.96,
  );
  const conduitFloor = clamp(
    0.14 + 0.13 * pulmonarySourceDrive01 - 0.04 * laToLvReliefDrive01
      - 0.080 * receiverPath01 - 0.052 * receiverCapacity01,
    0.06,
    0.30,
  );
  const conduitTarget = clamp(
    previousZ * conduitRetention01 + conduitFloor * (1 - conduitRetention01),
    0,
    1,
  );
  const baseTarget = clamp(reservoirTarget * (1 - path01) + conduitTarget * path01, 0, 1);
  const phaseLockedGain01 = clamp(params.laAVPlanePhaseLockedTrajectoryGain01, 0, 1);
  if (phaseLockedGain01 <= 0) return baseTarget;
  const systolicDescentWindow01 = raisedCosineWindow(theta, 0.055, 0.425);
  const earlyConduitWindow01 = raisedCosineWindow(
    theta,
    params.lvEarlyFillingReceiverReliefStartTheta,
    params.lvEarlyFillingReceiverReliefEndTheta,
  );
  ...
  const phaseConduitGate01 = clamp(mvOpenDrive01 * earlyConduitWindow01, 0, 1);
  const phaseReservoirTarget = clamp(
    ejectionDrive01
      * (0.76 + 0.24 * systolicDescentWindow01)
      * (1 + 0.10 * pulmonarySourceDrive01)
      * (1 - 0.05 * laToLvReliefDrive01),
    0,
    1,
  );
  const phaseConduitRetention01 = clamp(
    0.92
      - 0.10 * mvForwardFlowDrive01
      - 0.12 * mvForwardDecelDrive01
      + 0.06 * receiverPath01
      + 0.10 * receiverCapacity01,
    0.68,
  ...
  const phaseConduitFloor = clamp(
    0.12
      + 0.08 * pulmonarySourceDrive01
      - 0.025 * laToLvReliefDrive01
      - 0.035 * receiverCapacity01,
    0.075,
    0.24,
  );
  const phaseConduitTarget = clamp(
    previousZ * phaseConduitRetention01 + phaseConduitFloor * (1 - phaseConduitRetention01),
    0,
    1,
  );
  const phaseTarget = clamp(
    phaseReservoirTarget * (1 - phaseConduitGate01) + phaseConduitTarget * phaseConduitGate01,
    0,
    1,
  );
  return clamp(baseTarget * (1 - phaseLockedGain01) + phaseTarget * phaseLockedGain01, 0, 1);
}
...
function leftAtrialEffectiveGeometryReadback(input: {
  ...
  const usesLobeGeometry =
    ...
    || geometryMode === "av-plane-full-left-v16-transfer-hysteresis-v6";
...
function nextLeftAtrialAVPlaneWorkCoordinateV1(input: {
  ...
  const phaseLockedGain01 = clamp(input.params.laAVPlanePhaseLockedTrajectoryGain01, 0, 1);
  if (phaseLockedGain01 > 0 && input.theta != null) {
    const mvOpenDrive01 = smoothstep01(
      (input.mvOpen01 ?? input.previousMvOpen01)
        / Math.max(input.params.laAVPlaneReservoirCapacityMvOpenReleaseThreshold01, 1e-9),
    );
    const systolicDescentWindow01 = raisedCosineWindow(input.theta, 0.055, 0.425);
    const earlyConduitWindow01 = raisedCosineWindow(
      input.theta,
      input.params.lvEarlyFillingReceiverReliefStartTheta,
      input.params.lvEarlyFillingReceiverReliefEndTheta,
    );
    const phaseConduitGate01 = clamp(mvOpenDrive01 * earlyConduitWindow01, 0, 1);
    const phaseReservoirTargetZNorm = clamp(
      Math.max(input.reservoirDrive01, systolicDescentWindow01)
        * (1 - 0.05 * mvOpenDrive01),
      0,
      1,
    );
    const phaseConduitTargetZNorm = clamp(
      input.previousZNorm * 0.94 + 0.10 * 0.06,
      0,
      1,
    );
    const phaseTargetZNorm = clamp(
      phaseReservoirTargetZNorm * (1 - phaseConduitGate01)
        + phaseConduitTargetZNorm * phaseConduitGate01,
      0,
      1,
    );
    const phaseTauSec = phaseTargetZNorm >= input.previousZNorm
      ? Math.max(input.params.laAVPlaneReservoirCapacityRiseTauSec, input.dtSec, 1e-9)
      : Math.max(input.params.laAVPlaneReservoirCapacityReleaseTauSec, input.dtSec, 1e-9);
    const phaseTargetZDotNormPerSec = clamp(
      (phaseTargetZNorm - input.previousZNorm) / phaseTauSec,
      -maxVelocityNormPerSec,
      maxVelocityNormPerSec,
    );
    zDotNormPerSec = clamp(
      zDotNormPerSec * (1 - phaseLockedGain01) + phaseTargetZDotNormPerSec * phaseLockedGain01,
      -maxVelocityNormPerSec,
      maxVelocityNormPerSec,
    );
  }
