...
import type { MainWireIntegratedStudioStandard70BaselineAssessmentV2 } from
...
import surface, { MAIN_WIRE_INTEGRATED_STUDIO_ALGEBRAIC_PULMONARY_ROOT_SURFACE_V1 as historicalSurface } from
...
export type MainWireStandard70LaunchBaselineV1 = Readonly<{
  ...
  qualificationCheckpoint: typeof launchJson.qualificationCheckpoint;
  capture: ScenarioCaptureV2 & Readonly<{ fixture: StudioJsonObjectV2 }>;
  validationReport: MainWireIntegratedStudioStandard70BaselineAssessmentV2;
  provenance: Readonly<{
...
/** App-owned new-session selection, shared by local and remote releases.
 * Only the reviewed exact manifest/Surface and recognized baseline fixtures
 * receive this capture. Saved captures and release records are never mutated. */
export function resolveRegisteredModelLaunchDefaultsV1<TFixture extends StudioJsonValueV2>(input: Readonly<{
  ...
  return Object.freeze({ defaultFixture: launch.capture.fixture,
    defaultCheckpoint: launch.capture.checkpoint });
}
