...
import type { MainWireIntegratedModelStandard71CheckpointV1 } from "@/engine/myocardium/MainWireIntegratedModelStandard71CheckpointV1";
import { createMainWireIntegratedStudioStandard71CoreReleaseV1,
...
import checkpointJson from "./standard71-settled-baseline-checkpoint.json";
import launchCheckpointJson from "./standard71-launch-checkpoint.json";
import bindingEvidence from "./standard71-baseline-binding-evidence.json";

export const MAIN_WIRE_STANDARD71_DEFAULT_FIXTURE_V1 = Object.freeze({
...
export const MAIN_WIRE_STANDARD71_QUALIFICATION_CHECKPOINT_V1 = cloneAndFreezeStudioJson(checkpointJson) as unknown as MainWireIntegratedModelStandard71CheckpointV1;
export const MAIN_WIRE_STANDARD71_SETTLED_CHECKPOINT_V1 = cloneAndFreezeStudioJson(launchCheckpointJson) as unknown as MainWireIntegratedModelStandard71CheckpointV1;
const checkpoint = MAIN_WIRE_STANDARD71_QUALIFICATION_CHECKPOINT_V1;
const launch = MAIN_WIRE_STANDARD71_SETTLED_CHECKPOINT_V1;
if (bindingEvidence.status !== "cold-replay-and-checkpoint-parity-passed"
  ...
  throw new Error("Standard71 baseline binding evidence and checkpoint disagree");
}
const defaultCanonical = studioCanonicalJsonStringify(MAIN_WIRE_STANDARD71_DEFAULT_FIXTURE_V1);
...
export function createCircleHeartExactModelReleaseV1() {
  const core = createMainWireIntegratedStudioStandard71CoreReleaseV1();
