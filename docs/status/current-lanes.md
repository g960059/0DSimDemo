...
| atrial bridge | Phase 5.5 atrial bridge shootout plus Phase 5.5B blocker localization now record measured E0/A0/A1 evidence. `atrial-bridge-blocker-localization-phase5p5b-result-v1` shows HR105 remains a common non-settle boundary with cap-tail LA/RA metrics recorded; HR90 separates candidates because A0 settles while E0/A1 cap. A1 valve diode contamination remains supported after beat/second normalization, A1 repeatability is `not-supported` as a blocker after full-beat phase-resampled repeatability, and A1 isolated roughness remains not sampling-invariant across 120/240/480/960 Hz. A1 diagnostic variants are measured but non-selectable. No bridge is recommended or selected. | owner selection remains pending and oracle selection review remains pending; high-HR common non-settle plus normalized A1 valve-event contamination and sampling-invariance blockers must be resolved or explicitly bounded before Phase 6 bridge selection | decide whether high-HR non-settle is shared ModelCore boundary behavior or atrial-provider specific, then either tune a new A1 candidate or defer to atrial Land/RDQ path | final atrial physiology, AF validation, atrial Land/RDQ validation, production atrial bridge wiring |
...
1. Resolve or explicitly bound the Phase 5.5B HR105 atrial bridge non-settle boundary and normalized A1 valve/sampling blockers before Decision 21 Phase 6 bridge selection.
