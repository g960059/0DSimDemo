...
4. Advance atrial figure-eight work in a separate lane at HR75/90 normal and
   preload envelopes. Phase 5AS shows parameter-only RA soft-sleeve tuning is
   insufficient for selection; next useful work is an explicit structural A1.1
   candidate or phase-lobe design. Treat HR105/120 as edge evidence, not as an
   LV Land default gate.
