...
2. The next myocardium chamber decision is RA/LA candidate evidence, not legacy
   deletion. Do not bundle it with atrial figure-eight selection, official case
   tuning, qDot/valve/Tref/source-stress tuning, root/Zc re-litigation, or
   legacy deletion.
