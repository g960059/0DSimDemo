...
4. Advance atrial figure-eight work in a separate lane at HR75/90 normal and
   ...
   to the user-0 staged all-chamber runtime default. Continue calibration from
   that LandAtrial default floor, not from A1/A2 bridge tuning. Treat HR105/120
   as edge evidence, not as a default gate.
