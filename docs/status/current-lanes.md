...
2. The next myocardium chamber decision is an explicit RA atrial source-stress
   sign-semantics/pressure-adapter candidate, not legacy deletion or
   ...
   clamping, root/Zc re-litigation, or legacy deletion.
...
4. Advance atrial figure-eight work in a separate lane at HR75/90 normal and
   ...
   selection; next useful work is a named AtrialPhysiologyBridgeV2/A2 contract
   with explicit reservoir/conduit/booster coupling, self dV/dt/conduit damping,
   tension-state booster, external-coupling debug terms, and absolute atrial
   waveform targets. Treat HR105/120 as edge evidence, not as an LV Land default
   gate.
