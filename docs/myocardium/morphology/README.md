...
Per-run blocker and advisory classifications live in the PR and report that
produced them, not in this document. The lane frontier is whatever the latest
morphology run and owner visual review say.

Current standing constraint: disease profiles stay report-only until a normal
baseline passes strict morphology and owner review.
