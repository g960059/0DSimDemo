...
replay evidence instead. The current validation PASS means the verifier can
reproduce and report this outcome deterministically; the artifactGate remains
FAIL/review because some prescribed legacy VLV samples are outside the selected
v2 LV calibration domain. RV pressure overload not covered, ventricular
interdependence not covered, right-heart failure not covered, and TriSeg
future not covered by this gate.
