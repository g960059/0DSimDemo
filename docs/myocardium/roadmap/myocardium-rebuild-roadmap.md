...
- interpretation: the Phase 5AD AoV-boundary signal can be carried by a separated experimental boundary/root inertance hook without direct `Ao_SA.L` adoption. This is mechanism routing evidence, not production/default adoption or sourced Zc calibration.
