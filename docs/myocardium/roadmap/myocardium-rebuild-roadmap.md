...
- current outcome: validation PASS means the verifier deterministically reports the evidence; artifactGate remains FAIL/review because selected v2 LV calibration-domain coverage fails for part of the prescribed legacy VLV trajectory
