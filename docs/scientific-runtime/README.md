# Integrated V3 numerical model

This directory contains the current guidance for the integrated V3 numerical
model:

- [`INTEGRATED-MODEL-0001-current-state.md`](./INTEGRATED-MODEL-0001-current-state.md)
  defines the active exact release, numerical authority, Studio boundary, and
...
- [`INTEGRATED-MODEL-0030-periodic-five-wall-mechanical-port-ledger-dt-characterization-result.md`](./INTEGRATED-MODEL-0030-periodic-five-wall-mechanical-port-ledger-dt-characterization-result.md)
  records the completed shared-source three-grid characterization, the
...
Studio identity, persistence, authoring, and publication are defined only by
[`../studio/DESIGN-STUDIO-003-experiment-data-architecture.md`](../studio/DESIGN-STUDIO-003-experiment-data-architecture.md).
