...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Periodic ventricular external work                  | The archived implementation passed its frozen 1 ms/0.5 ms admission, pressure-basis decomposition, checkpoint, and accepted-path gates. It did not establish a public catalog, PVA, physiological validation, or clinical validation. | Extract the analysis core from current `main` in a small Engineering-only PR. Historical qualification does not transfer to a reconstructed implementation identity; a future Confirmatory qualification requires a new preregistration and evidence lineage. |
