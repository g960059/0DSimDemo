...
current runtime. They are not normative runtime or qualification inputs for a
future passive-surface construction. Declared numerical cases may be reused
only under a new Engineering identity.

PR558 must not be merged, rebased, squashed, or force-pushed. The consumed
passive-equilibrium V2 engineering attempt must not be rerun, overwritten, or
reinterpreted under the same attempt identity. It remains a failed result with
...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Periodic ventricular external work                  | The archived implementation passed its frozen 1 ms/0.5 ms admission, pressure-basis decomposition, checkpoint, and accepted-path gates. It did not establish a public catalog, PVA, physiological validation, or clinical validation. | Reconstruct the archived transmural-boundary-work analysis core against current `main` under a new Engineering identity. Historical qualification does not transfer; a future Confirmatory qualification requires a new preregistration and evidence lineage. |
...
limited to the periodic transmural-boundary-work analysis core and focused tests.
...
Global uniqueness remains unestablished and is outside the claim of any finite
multi-seed comparison or local pilot.
