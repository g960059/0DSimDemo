...
New Sessions resolve one active exact-model/Surface bundle and its analysis
profile. Saved Experiments and Snapshots retain their explicit pins; a failed
historical load must never substitute the active release.
