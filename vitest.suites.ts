...
export const fastTests = [
  ...
  "__tests__/modelSurfaceManifestV1.test.ts",
...
export const regressionTests = [
  ...
  "__tests__/integratedScientificWorkerAdvanceBatchV1.test.ts",
  ...
  "__tests__/scientificProductIntegratedV3LaneV1.test.ts",
  "__tests__/scientificProductLaneSelectorV1.test.ts",
