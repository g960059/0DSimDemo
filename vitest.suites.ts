...
export const fastTests = [
  ...
  "__tests__/mainWireIntegratedModelMethodSpecificPvaResearchV1.test.ts",
  "__tests__/mainWireIntegratedModelPvaDiastolicReferenceComparisonV1.test.ts",
  ...
  "__tests__/mainWireIntegratedModelPhaseWisePvaQualificationV2.test.ts",
  ...
  "__tests__/mainWireIntegratedModelPeriodicFiveWallMechanicalPortLedgerDtCharacterizationV1.test.ts",
  ...
  "__tests__/mainWireIntegratedModelTransientVenousReturnReductionV1.test.ts",
  ...
  "__tests__/mainWirePassiveEquilibriumPointSolverComparisonEngineeringV1.test.ts",
  "__tests__/mainWireIntrinsicVentricularPassiveReducedSurfacePilotV1.test.ts",
...
export const canonicalScientificTests = [
  ...
  "__tests__/mainWireIntegratedModelPeriodicFiveWallMechanicalPortLedgerEngineeringV1.test.ts",
