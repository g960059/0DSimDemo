...
export const canonicalScientificTests = [
  ...
  "__tests__/mainWireAorticOutflowV10MatchedAlphaFixedPhysicalHorizonSentinelV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHeartRateLawV1.test.ts",
  ...
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHeartRateLawIctMechanismV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHr90AtrioventricularDelayBracketRunnerV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHr90AtrioventricularDelayMechanismV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismRunnerV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingHr90OpeningLoadMechanismAnalysisV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingRobustnessEnvelopeFixedHorizonSentinelV1.test.ts",
  "__tests__/mainWireAorticOutflowV10MatchedAlphaSaturatingPressureRecoveryGeometrySentinelV1.test.ts",
  ...
  "__tests__/mainWireAorticOutflowV10MatchedAlphaTimingPolicyBridgeV1.test.ts",
  "__tests__/mainWireAorticOutflowV10LimitingCornerDtConvergenceV1.test.ts",
  "__tests__/mainWireVentricularCalciumMatchedAlphaTimingPolicyBridgeV1.test.ts",
  "__tests__/mainWireVentricularCalciumMatchedAlphaSaturatingHeartRateLawV1.test.ts",
  "__tests__/mainWireAorticOutflowV9PressureRecoveryBaselineComparisonV1.test.ts",
  "__tests__/mainWireAorticValveLvotKineticCorrectionV1.test.ts",
  "__tests__/mainWireAorticValvePressureRecoveryAblationV1.test.ts",
